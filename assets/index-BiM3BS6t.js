 ...
 */var mg;function Nw(){if(mg)return Se;mg=1;var r=Symbol.for("react.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),u=Symbol.for("react.provider"),h=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),_=Symbol.for("react.suspense"),w=Symbol.for("react.memo"),N=Symbol.for("react.lazy"),k=Symbol.iterator;function I(L){return L===null||typeof L!="object"?null:(L=k&&L[k]||L["@@iterator"],typeof L=="function"?L:null)}var z={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},H=Object.assign,Y={};function W(L,G,ue){this.props=L,this.context=G,this.refs=Y,this.updater=ue||z}W.prototype.isReactComponent={},W.prototype.setState=function(L,G){if(typeof L!="object"&&typeof L!="function"&&L!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,L,G,"setState")},W.prototype.forceUpdate=function(L){this.updater.enqueueForceUpdate(this,L,"forceUpdate")};function me(){}me.prototype=W.prototype;function $(L,G,ue){this.props=L,this.context=G,this.refs=Y,this.updater=ue||z}var ae=$.prototype=new me;ae.constructor=$,H(ae,W.prototype),ae.isPureReactComponent=!0;var ce=Array.isArray,ye=Object.prototype.hasOwnProperty,B={current:null},P={key:!0,ref:!0,__self:!0,__source:!0};function x(L,G,ue){var Ee,xe={},Ne=null,Me=null;if(G!=null)for(Ee in G.ref!==void 0&&(Me=G.ref),G.key!==void 0&&(Ne=""+G.key),G)ye.call(G,Ee)&&!P.hasOwnProperty(Ee)&&(xe[Ee]=G[Ee]);var je=arguments.length-2;if(je===1)xe.children=ue;else if(1<je){for(var We=Array(je),mt=0;mt<je;mt++)We[mt]=arguments[mt+2];xe.children=We}if(L&&L.defaultProps)for(Ee in je=L.defaultProps,je)xe[Ee]===void 0&&(xe[Ee]=je[Ee]);return{$$typeof:r,type:L,key:Ne,ref:Me,props:xe,_owner:B.current}}function C(L,G){return{$$typeof:r,type:L.type,key:G,ref:L.ref,props:L.props,_owner:L._owner}}function R(L){return typeof L=="object"&&L!==null&&L.$$typeof===r}function A(L){var G={"=":"=0",":":"=2"};return"$"+L.replace(/[=:]/g,function(ue){return G[ue]})}var O=/\/+/g;function T(L,G){return typeof L=="object"&&L!==null&&L.key!=null?A(""+L.key):G.toString(36)}function we(L,G,ue,Ee,xe){var Ne=typeof L;(Ne==="undefined"||Ne==="boolean")&&(L=null);var Me=!1;if(L===null)Me=!0;else switch(Ne){case"string":case"number":Me=!0;break;case"object":switch(L.$$typeof){case r:case e:Me=!0}}if(Me)return Me=L,xe=xe(Me),L=Ee===""?"."+T(Me,0):Ee,ce(xe)?(ue="",L!=null&&(ue=L.replace(O,"$&/")+"/"),we(xe,G,ue,"",function(mt){return mt})):xe!=null&&(R(xe)&&(xe=C(xe,ue+(!xe.key||Me&&Me.key===xe.key?"":(""+xe.key).replace(O,"$&/")+"/")+L)),G.push(xe)),1;if(Me=0,Ee=Ee===""?".":Ee+":",ce(L))for(var je=0;je<L.length;je++){Ne=L[je];var We=Ee+T(Ne,je);Me+=we(Ne,G,ue,We,xe)}else if(We=I(L),typeof We=="function")for(L=We.call(L),je=0;!(Ne=L.next()).done;)Ne=Ne.value,We=Ee+T(Ne,je++),Me+=we(Ne,G,ue,We,xe);else if(Ne==="object")throw G=String(L),Error("Objects are not valid as a React child (found: "+(G==="[object Object]"?"object with keys {"+Object.keys(L).join(", ")+"}":G)+"). If you meant to render a collection of children, use an array instead.");return Me}function ve(L,G,ue){if(L==null)return L;var Ee=[],xe=0;return we(L,Ee,"","",function(Ne){return G.call(ue,Ne,xe++)}),Ee}function Qe(L){if(L._status===-1){var G=L._result;G=G(),G.then(function(ue){(L._status===0||L._status===-1)&&(L._status=1,L._result=ue)},function(ue){(L._status===0||L._status===-1)&&(L._status=2,L._result=ue)}),L._status===-1&&(L._status=0,L._result=G)}if(L._status===1)return L._result.default;throw L._result}var Oe={current:null},ee={transition:null},he={ReactCurrentDispatcher:Oe,ReactCurrentBatchConfig:ee,ReactCurrentOwner:B};function ne(){throw Error("act(...) is not supported in production builds of React.")}return Se.Children={map:ve,forEach:function(L,G,ue){ve(L,function(){G.apply(this,arguments)},ue)},count:function(L){var G=0;return ve(L,function(){G++}),G},toArray:function(L){return ve(L,function(G){return G})||[]},only:function(L){if(!R(L))throw Error("React.Children.only expected to receive a single React element child.");return L}},Se.Component=W,Se.Fragment=t,Se.Profiler=l,Se.PureComponent=$,Se.StrictMode=s,Se.Suspense=_,Se.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=he,Se.act=ne,Se.cloneElement=function(L,G,ue){if(L==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+L+".");var Ee=H({},L.props),xe=L.key,Ne=L.ref,Me=L._owner;if(G!=null){if(G.ref!==void 0&&(Ne=G.ref,Me=B.current),G.key!==void 0&&(xe=""+G.key),L.type&&L.type.defaultProps)var je=L.type.defaultProps;for(We in G)ye.call(G,We)&&!P.hasOwnProperty(We)&&(Ee[We]=G[We]===void 0&&je!==void 0?je[We]:G[We])}var We=arguments.length-2;if(We===1)Ee.children=ue;else if(1<We){je=Array(We);for(var mt=0;mt<We;mt++)je[mt]=arguments[mt+2];Ee.children=je}return{$$typeof:r,type:L.type,key:xe,ref:Ne,props:Ee,_owner:Me}},Se.createContext=function(L){return L={$$typeof:h,_currentValue:L,_currentValue2:L,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},L.Provider={$$typeof:u,_context:L},L.Consumer=L},Se.createElement=x,Se.createFactory=function(L){var G=x.bind(null,L);return G.type=L,G},Se.createRef=function(){return{current:null}},Se.forwardRef=function(L){return{$$typeof:m,render:L}},Se.isValidElement=R,Se.lazy=function(L){return{$$typeof:N,_payload:{_status:-1,_result:L},_init:Qe}},Se.memo=function(L,G){return{$$typeof:w,type:L,compare:G===void 0?null:G}},Se.startTransition=function(L){var G=ee.transition;ee.transition={};try{L()}finally{ee.transition=G}},Se.unstable_act=ne,Se.useCallback=function(L,G){return Oe.current.useCallback(L,G)},Se.useContext=function(L){return Oe.current.useContext(L)},Se.useDebugValue=function(){},Se.useDeferredValue=function(L){return Oe.current.useDeferredValue(L)},Se.useEffect=function(L,G){return Oe.current.useEffect(L,G)},Se.useId=function(){return Oe.current.useId()},Se.useImperativeHandle=function(L,G,ue){return Oe.current.useImperativeHandle(L,G,ue)},Se.useInsertionEffect=function(L,G){return Oe.current.useInsertionEffect(L,G)},Se.useLayoutEffect=function(L,G){return Oe.current.useLayoutEffect(L,G)},Se.useMemo=function(L,G){return Oe.current.useMemo(L,G)},Se.useReducer=function(L,G,ue){return Oe.current.useReducer(L,G,ue)},Se.useRef=function(L){return Oe.current.useRef(L)},Se.useState=function(L){return Oe.current.useState(L)},Se.useSyncExternalStore=function(L,G,ue){return Oe.current.useSyncExternalStore(L,G,ue)},Se.useTransition=function(){return Oe.current.useTransition()},Se.version="18.3.1",Se}var gg;function Zd(){return gg||(gg=1,rd.exports=Nw()),rd.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _g;function Rw(){if(_g)return kl;_g=1;var r=Zd(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),s=Object.prototype.hasOwnProperty,l=r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,u={key:!0,ref:!0,__self:!0,__source:!0};function h(m,_,w){var N,k={},I=null,z=null;w!==void 0&&(I=""+w),_.key!==void 0&&(I=""+_.key),_.ref!==void 0&&(z=_.ref);for(N in _)s.call(_,N)&&!u.hasOwnProperty(N)&&(k[N]=_[N]);if(m&&m.defaultProps)for(N in _=m.defaultProps,_)k[N]===void 0&&(k[N]=_[N]);return{$$typeof:e,type:m,key:I,ref:z,props:k,_owner:l.current}}return kl.Fragment=t,kl.jsx=h,kl.jsxs=h,kl}var yg;function Aw(){return yg||(yg=1,nd.exports=Rw()),nd.exports}var y=Aw(),le=Zd();const vg=Tw(le);var Nu={},id={exports:{}},Yt={},sd={exports:{}},od={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var wg;function Pw(){return wg||(wg=1,function(r){function e(ee,he){var ne=ee.length;ee.push(he);e:for(;0<ne;){var L=ne-1>>>1,G=ee[L];if(0<l(G,he))ee[L]=he,ee[ne]=G,ne=L;else break e}}function t(ee){return ee.length===0?null:ee[0]}function s(ee){if(ee.length===0)return null;var he=ee[0],ne=ee.pop();if(ne!==he){ee[0]=ne;e:for(var L=0,G=ee.length,ue=G>>>1;L<ue;){var Ee=2*(L+1)-1,xe=ee[Ee],Ne=Ee+1,Me=ee[Ne];if(0>l(xe,ne))Ne<G&&0>l(Me,xe)?(ee[L]=Me,ee[Ne]=ne,L=Ne):(ee[L]=xe,ee[Ee]=ne,L=Ee);else if(Ne<G&&0>l(Me,ne))ee[L]=Me,ee[Ne]=ne,L=Ne;else break e}}return he}function l(ee,he){var ne=ee.sortIndex-he.sortIndex;return ne!==0?ne:ee.id-he.id}if(typeof performance=="object"&&typeof performance.now=="function"){var u=performance;r.unstable_now=function(){return u.now()}}else{var h=Date,m=h.now();r.unstable_now=function(){return h.now()-m}}var _=[],w=[],N=1,k=null,I=3,z=!1,H=!1,Y=!1,W=typeof setTimeout=="function"?setTimeout:null,me=typeof clearTimeout=="function"?clearTimeout:null,$=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function ae(ee){for(var he=t(w);he!==null;){if(he.callback===null)s(w);else if(he.startTime<=ee)s(w),he.sortIndex=he.expirationTime,e(_,he);else break;he=t(w)}}function ce(ee){if(Y=!1,ae(ee),!H)if(t(_)!==null)H=!0,Qe(ye);else{var he=t(w);he!==null&&Oe(ce,he.startTime-ee)}}function ye(ee,he){H=!1,Y&&(Y=!1,me(x),x=-1),z=!0;var ne=I;try{for(ae(he),k=t(_);k!==null&&(!(k.expirationTime>he)||ee&&!A());){var L=k.callback;if(typeof L=="function"){k.callback=null,I=k.priorityLevel;var G=L(k.expirationTime<=he);he=r.unstable_now(),typeof G=="function"?k.callback=G:k===t(_)&&s(_),ae(he)}else s(_);k=t(_)}if(k!==null)var ue=!0;else{var Ee=t(w);Ee!==null&&Oe(ce,Ee.startTime-he),ue=!1}return ue}finally{k=null,I=ne,z=!1}}var B=!1,P=null,x=-1,C=5,R=-1;function A(){return!(r.unstable_now()-R<C)}function O(){if(P!==null){var ee=r.unstable_now();R=ee;var he=!0;try{he=P(!0,ee)}finally{he?T():(B=!1,P=null)}}else B=!1}var T;if(typeof $=="function")T=function(){$(O)};else if(typeof MessageChannel<"u"){var we=new MessageChannel,ve=we.port2;we.port1.onmessage=O,T=function(){ve.postMessage(null)}}else T=function(){W(O,0)};function Qe(ee){P=ee,B||(B=!0,T())}function Oe(ee,he){x=W(function(){ee(r.unstable_now())},he)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(ee){ee.callback=null},r.unstable_continueExecution=function(){H||z||(H=!0,Qe(ye))},r.unstable_forceFrameRate=function(ee){0>ee||125<ee?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):C=0<ee?Math.floor(1e3/ee):5},r.unstable_getCurrentPriorityLevel=function(){return I},r.unstable_getFirstCallbackNode=function(){return t(_)},r.unstable_next=function(ee){switch(I){case 1:case 2:case 3:var he=3;break;default:he=I}var ne=I;I=he;try{return ee()}finally{I=ne}},r.unstable_pauseExecution=function(){},r.unstable_requestPaint=function(){},r.unstable_runWithPriority=function(ee,he){switch(ee){case 1:case 2:case 3:case 4:case 5:break;default:ee=3}var ne=I;I=ee;try{return he()}finally{I=ne}},r.unstable_scheduleCallback=function(ee,he,ne){var L=r.unstable_now();switch(typeof ne=="object"&&ne!==null?(ne=ne.delay,ne=typeof ne=="number"&&0<ne?L+ne:L):ne=L,ee){case 1:var G=-1;break;case 2:G=250;break;case 5:G=1073741823;break;case 4:G=1e4;break;default:G=5e3}return G=ne+G,ee={id:N++,callback:he,priorityLevel:ee,startTime:ne,expirationTime:G,sortIndex:-1},ne>L?(ee.sortIndex=ne,e(w,ee),t(_)===null&&ee===t(w)&&(Y?(me(x),x=-1):Y=!0,Oe(ce,ne-L))):(ee.sortIndex=G,e(_,ee),H||z||(H=!0,Qe(ye))),ee},r.unstable_shouldYield=A,r.unstable_wrapCallback=function(ee){var he=I;return function(){var ne=I;I=he;try{return ee.apply(this,arguments)}finally{I=ne}}}}(od)),od}var Eg;function bw(){return Eg||(Eg=1,sd.exports=Pw()),sd.exports}/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function my(r,e){if(r.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const t={alg:"none",type:"JWT"},s=e||"demo-project",l=r.iat||0,u=r.sub||r.user_id;if(!u)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const h=Object.assign({iss:`https://securetoken.google.com/${s}`,aud:s,iat:l,exp:l+3600,auth_time:l,sub:u,user_id:u,firebase:{sign_in_provider:"custom",identities:{}}},r);return[zu(JSON.stringify(t)),zu(JSON.stringify(h)),""].join(".")}const Ol={};function Qw(){const r={prod:[],emulator:[]};for(const e of Object.keys(Ol))Ol[e]?r.emulator.push(e):r.prod.push(e);return r}function Xw(r){let e=document.getElementById(r),t=!1;return e||(e=document.createElement("div"),e.setAttribute("id",r),t=!0),{created:t,element:e}}let Ng=!1;function rf(r,e){if(typeof window>"u"||typeof document>"u"||!us(window.location.host)||Ol[r]===e||Ol[r]||Ng)return;Ol[r]=e;function t(I){return`__firebase__banner__${I}`}const s="__firebase__banner",u=Qw().prod.length>0;function h(){const I=document.getElementById(s);I&&I.remove()}function m(I){I.style.display="flex",I.style.background="#7faaf0",I.style.position="fixed",I.style.bottom="5px",I.style.left="5px",I.style.padding=".5em",I.style.borderRadius="5px",I.style.alignItems="center"}function _(I,z){I.setAttribute("width","24"),I.setAttribute("id",z),I.setAttribute("height","24"),I.setAttribute("viewBox","0 0 24 24"),I.setAttribute("fill","none"),I.style.marginLeft="-6px"}function w(){const I=document.createElement("span");return I.style.cursor="pointer",I.style.marginLeft="16px",I.style.fontSize="24px",I.innerHTML=" &times;",I.onclick=()=>{Ng=!0,h()},I}function N(I,z){I.setAttribute("id",z),I.innerText="Learn more",I.href="https://firebase.google.com/docs/studio/preview-apps#preview-backend",I.setAttribute("target","__blank"),I.style.paddingLeft="5px",I.style.textDecoration="underline"}function k(){const I=Xw(s),z=t("text"),H=document.getElementById(z)||document.createElement("span"),Y=t("learnmore"),W=document.getElementById(Y)||document.createElement("a"),me=t("preprendIcon"),$=document.getElementById(me)||document.createElementNS("http://www.w3.org/2000/svg","svg");if(I.created){const ae=I.element;m(ae),N(W,Y);const ce=w();_($,me),ae.append($,H,W,ce),document.body.appendChild(ae)}u?(H.innerText="Preview backend disconnected.",$.innerHTML=`<g clip-path="url(#clip0_6013_33858)">
...
</defs>`,H.innerText="Preview backend running in this workspace."),H.setAttribute("id",z)}document.readyState==="loading"?window.addEventListener("DOMContentLoaded",k):k()}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i1="FirebaseError";class br extends Error{constructor(e,t,s){super(t),this.code=e,this.customData=s,this.name=i1,Object.setPrototypeOf(this,br.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,ra.prototype.create)}}class ra{constructor(e,t,s){this.service=e,this.serviceName=t,this.errors=s}create(e,...t){const s=t[0]||{},l=`${this.service}/${e}`,u=this.errors[e],h=u?s1(u,s):"Error",m=`${this.serviceName}: ${h} (${l}).`;return new br(l,m,s)}}function s1(r,e){return r.replace(o1,(t,s)=>{const l=e[s];return l!=null?String(l):`<${s}?>`})}const o1=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _y=function(r){let e={},t={},s={},l="";try{const u=r.split(".");e=Wl(Hu(u[0])||""),t=Wl(Hu(u[1])||""),l=u[2],s=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:s,signature:l}},l1=function(r){const e=_y(r),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},a1=function(r){const e=_y(r).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const f1=function(r){const e=[];let t=0;for(let s=0;s<r.length;s++){let l=r.charCodeAt(s);if(l>=55296&&l<=56319){const u=l-55296;s++,J(s<r.length,"Surrogate pair missing trail surrogate.");const h=r.charCodeAt(s)-56320;l=65536+(u<<10)+h}l<128?e[t++]=l:l<2048?(e[t++]=l>>6|192,e[t++]=l&63|128):l<65536?(e[t++]=l>>12|224,e[t++]=l>>6&63|128,e[t++]=l&63|128):(e[t++]=l>>18|240,e[t++]=l>>12&63|128,e[t++]=l>>6&63|128,e[t++]=l&63|128)}return e},mc=function(r){let e=0;for(let t=0;t<r.length;t++){const s=r.charCodeAt(t);s<128?e++:s<2048?e+=2:s>=55296&&s<=56319?(e+=4,t++):e+=3}return e};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wu=new Map,uE=new Map,Ad=new Map;function Og(r,e){try{r.container.addComponent(e)}catch(t){Nr.debug(`Component ${e.name} failed to register with FirebaseApp ${r.name}`,t)}}function ns(r){const e=r.name;if(Ad.has(e))return Nr.debug(`There were multiple attempts to register component ${e}.`),!1;Ad.set(e,r);for(const t of Wu.values())Og(t,r);for(const t of uE.values())Og(t,r);return!0}function _c(r,e){const t=r.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),r.container.getProvider(e)}function mn(r){return r==null?!1:r.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cs=lE;function wy(r,e={}){let t=r;typeof e!="object"&&(e={name:e});const s=Object.assign({name:Rd,automaticDataCollectionEnabled:!0},e),l=s.name;if(typeof l!="string"||!l)throw di.create("bad-app-name",{appName:String(l)});if(t||(t=fy()),!t)throw di.create("no-options");const u=Wu.get(l);if(u){if(mi(t,u.options)&&mi(s,u.config))return u;throw di.create("duplicate-app",{appName:l})}const h=new _1(l);for(const _ of Ad.values())h.addComponent(_);const m=new hE(t,s,h);return Wu.set(l,m),m}function af(r=Rd){const e=Wu.get(r);if(!e&&r===Rd&&fy())return wy();if(!e)throw di.create("no-app",{appName:r});return e}function er(r,e,t){var s;let l=(s=aE[r])!==null&&s!==void 0?s:r;t&&(l+=`-${t}`);const u=l.match(/\s|\//),h=e.match(/\s|\//);if(u||h){const m=[`Unable to register library "${l}" with version "${e}":`];u&&m.push(`library name "${l}" contains illegal characters (whitespace or "/")`),u&&h&&m.push("and"),h&&m.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Nr.warn(m.join(" "));return}ns(new gi(`${l}-version`,()=>({library:l,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $u=new gc("@firebase/auth");function SE(r,...e){$u.logLevel<=Fe.WARN&&$u.warn(`Auth (${cs}): ${r}`,...e)}function Lu(r,...e){$u.logLevel<=Fe.ERROR&&$u.error(`Auth (${cs}): ${r}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ia{constructor(e,t){this.shortDelay=e,this.longDelay=t,Rr(t>e,"Short delay should be less than long delay!"),this.isMobile=sf()||gy()}get(){return IE()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function OE(r,e){return Dr(r,"POST","/v1/accounts:delete",e)}async function Gu(r,e){return Dr(r,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qu(r){var e;const t=r.auth,s=await r.getIdToken(),l=await Gl(r,Gu(t,{idToken:s}));pe(l?.users.length,t,"internal-error");const u=l.users[0];r._notifyReloadListener(u);const h=!((e=u.providerUserInfo)===null||e===void 0)&&e.length?Ry(u.providerUserInfo):[],m=UE(r.providerData,h),_=r.isAnonymous,w=!(r.email&&u.passwordHash)&&!m?.length,N=_?w:!1,k={uid:u.localId,displayName:u.displayName||null,photoURL:u.photoUrl||null,email:u.email||null,emailVerified:u.emailVerified||!1,phoneNumber:u.phoneNumber||null,tenantId:u.tenantId||null,providerData:m,metadata:new bd(u.createdAt,u.lastLoginAt),isAnonymous:N};Object.assign(r,k)}async function FE(r){const e=Vn(r);await qu(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function UE(r,e){return[...r.filter(s=>!e.some(l=>l.providerId===s.providerId)),...e]}function Ry(r){return r.map(e=>{var{providerId:t}=e,s=uf(e,["providerId"]);return{providerId:t,uid:s.rawId||"",displayName:s.displayName||null,email:s.email||null,phoneNumber:s.phoneNumber||null,photoURL:s.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mu(r,e,t){return`firebase:${r}:${e}:${t}`}class co{constructor(e,t,s){this.persistence=e,this.auth=t,this.userKey=s;const{config:l,name:u}=this.auth;this.fullUserKey=Mu(this.userKey,l.apiKey,u),this.fullPersistenceKey=Mu("persistence",l.apiKey,u),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const t=await Gu(this.auth,{idToken:e}).catch(()=>{});return t?On._fromGetAccountInfoResponse(this.auth,t,e):null}return On._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,s="authUser"){if(!t.length)return new co(Ir(Hg),e,s);const l=(await Promise.all(t.map(async w=>{if(await w._isAvailable())return w}))).filter(w=>w);let u=l[0]||Ir(Hg);const h=Mu(s,e.config.apiKey,e.name);let m=null;for(const w of t)try{const N=await w._get(h);if(N){let k;if(typeof N=="string"){const I=await Gu(e,{idToken:N}).catch(()=>{});if(!I)break;k=await On._fromGetAccountInfoResponse(e,I,N)}else k=On._fromJSON(e,N);w!==u&&(m=k),u=w;break}}catch{}const _=l.filter(w=>w._shouldAllowMigration);return!u._shouldAllowMigration||!_.length?new co(u,e,s):(u=_[0],m&&await u._set(h,m.toJSON()),await Promise.all(t.map(async w=>{if(w!==u)try{await w._remove(h)}catch{}})),new co(u,e,s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rx(r,e){const t=_c(r,"auth");if(t.isInitialized()){const l=t.getImmediate(),u=t.getOptions();if(mi(u,e??{}))return l;Un(l,"already-initialized")}return t.initialize({options:e})}function ix(r,e){const t=e?.persistence||[],s=(Array.isArray(t)?t:[t]).map(Ir);e?.errorMap&&r._updateErrorMap(e.errorMap),r._initializeWithPersistence(s,e?.popupRedirectResolver)}function sx(r,e,t){const s=hs(r);pe(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const l=!1,u=Hy(e),{host:h,port:m}=ox(e),_=m===null?"":`:${m}`,w={url:`${u}//${h}${_}/`},N=Object.freeze({host:h,port:m,protocol:u.replace(":",""),options:Object.freeze({disableWarnings:l})});if(!s._canInitEmulator){pe(s.config.emulator&&s.emulatorConfig,s,"emulator-config-failed"),pe(mi(w,s.config.emulator)&&mi(N,s.emulatorConfig),s,"emulator-config-failed");return}s.config.emulator=w,s.emulatorConfig=N,s.settings.appVerificationDisabledForTesting=!0,us(h)?(nf(`${u}//${h}${_}`),rf("Auth",!0)):lx()}function Hy(r){const e=r.indexOf(":");return e<0?"":r.substr(0,e+1)}function ox(r){const e=Hy(r),t=/(\/\/)?([^?#/]+)/.exec(r.substr(e.length));if(!t)return{host:"",port:null};const s=t[2].split("@").pop()||"",l=/^(\[[^\]]+\])(:|$)/.exec(s);if(l){const u=l[1];return{host:u,port:Gg(s.substr(u.length+1))}}else{const[u,h]=s.split(":");return{host:u,port:Gg(h)}}}function Gg(r){if(!r)return null;const e=Number(r);return isNaN(e)?null:e}function lx(){function r(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",r):r())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ux(r,e){return yc(r,"POST","/v1/accounts:signInWithPassword",vi(r,e))}async function cx(r,e){return Dr(r,"POST","/v1/accounts:sendOobCode",vi(r,e))}async function hx(r,e){return cx(r,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function dx(r,e){return yc(r,"POST","/v1/accounts:signInWithEmailLink",vi(r,e))}async function fx(r,e){return yc(r,"POST","/v1/accounts:signInWithEmailLink",vi(r,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ho(r,e){return yc(r,"POST","/v1/accounts:signInWithIdp",vi(r,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sa extends By{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ku extends br{constructor(e,t,s,l){var u;super(t.code,t.message),this.operationType=s,this.user=l,Object.setPrototypeOf(this,Ku.prototype),this.customData={appName:e.name,tenantId:(u=e.tenantId)!==null&&u!==void 0?u:void 0,_serverResponse:t.customData._serverResponse,operationType:s}}static _fromErrorAndOperation(e,t,s,l){return new Ku(e,t,s,l)}}function Wy(r,e,t,s){return(e==="reauthenticate"?t._getReauthenticationResolver(r):t._getIdTokenResponse(r)).catch(u=>{throw u.code==="auth/multi-factor-auth-required"?Ku._fromErrorAndOperation(r,u,e,s):u})}async function _x(r,e,t=!1){const s=await Gl(r,e._linkToIdToken(r.auth,await r.getIdToken()),t);return yo._forOperation(r,"link",s)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gy{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(Yu,"1"),this.storage.removeItem(Yu),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wc{constructor(e){this.eventTarget=e,this.handlersMap={},this.boundEventHandler=this.handleEvent.bind(this)}static _getInstance(e){const t=this.receivers.find(l=>l.isListeningto(e));if(t)return t;const s=new wc(e);return this.receivers.push(s),s}isListeningto(e){return this.eventTarget===e}async handleEvent(e){const t=e,{eventId:s,eventType:l,data:u}=t.data,h=this.handlersMap[l];if(!h?.size)return;t.ports[0].postMessage({status:"ack",eventId:s,eventType:l});const m=Array.from(h).map(async w=>w(t.origin,u)),_=await Nx(m);t.ports[0].postMessage({status:"done",eventId:s,eventType:l,response:_})}_subscribe(e,t){Object.keys(this.handlersMap).length===0&&this.eventTarget.addEventListener("message",this.boundEventHandler),this.handlersMap[e]||(this.handlersMap[e]=new Set),this.handlersMap[e].add(t)}_unsubscribe(e,t){this.handlersMap[e]&&t&&this.handlersMap[e].delete(t),(!t||this.handlersMap[e].size===0)&&delete this.handlersMap[e],Object.keys(this.handlersMap).length===0&&this.eventTarget.removeEventListener("message",this.boundEventHandler)}}wc.receivers=[];/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $x="pendingRedirect",ju=new Map;class Gx extends ev{constructor(e,t,s=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,s),this.eventId=null}async execute(){let e=ju.get(this.auth._key());if(!e){try{const s=await qx(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(s)}catch(t){e=()=>Promise.reject(t)}ju.set(this.auth._key(),e)}return this.bypassAuthState||ju.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function qx(r,e){const t=Qx(e),s=Yx(r);if(!await s._isAvailable())return!1;const l=await s._get(t)==="true";return await s._remove(t),l}function Kx(r,e){ju.set(r._key(),e)}function Yx(r){return Ir(r._redirectPersistence)}function Qx(r){return Mu($x,r.config.apiKey,r.name)}async function Xx(r,e,t=!1){if(mn(r.app))return Promise.reject(fi(r));const s=hs(r),l=Vx(s,e),h=await new Gx(s,l,t).execute();return h&&!t&&(delete h.user._redirectEventId,await s._persistUserIfCurrent(h.user),await s._setRedirectUser(null,e)),h}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yC=16384,vC=45e3;let Xu=null;typeof MozWebSocket<"u"?Xu=MozWebSocket:typeof WebSocket<"u"&&(Xu=WebSocket);class Dn{constructor(e,t,s,l,u,h,m){this.connId=e,this.applicationId=s,this.appCheckToken=l,this.authToken=u,this.keepaliveTimer=null,this.frames=null,this.totalFrames=0,this.bytesSent=0,this.bytesReceived=0,this.log_=aa(this.connId),this.stats_=Ef(t),this.connURL=Dn.connectionURL_(t,h,m,l,s),this.nodeAdmin=t.nodeAdmin}static connectionURL_(e,t,s,l,u){const h={};return h[lv]=wf,typeof location<"u"&&location.hostname&&hv.test(location.hostname)&&(h[uv]=cv),t&&(h[av]=t),s&&(h[dv]=s),l&&(h[Md]=l),u&&(h[fv]=u),_v(e,pv,h)}open(e,t){this.onDisconnect=t,this.onMessage=e,this.log_("Websocket connecting to "+this.connURL),this.everConnected_=!1,Qi.set("previous_websocket_failure",!0);try{let s;t1(),this.mySock=new Xu(this.connURL,[],s)}catch(s){this.log_("Error instantiating WebSocket.");const l=s.message||s.data;l&&this.log_(l),this.onClosed_();return}this.mySock.onopen=()=>{this.log_("Websocket connected."),this.everConnected_=!0},this.mySock.onclose=()=>{this.log_("Websocket connection was disconnected."),this.mySock=null,this.onClosed_()},this.mySock.onmessage=s=>{this.handleIncomingFrame(s)},this.mySock.onerror=s=>{this.log_("WebSocket error.  Closing connection.");const l=s.message||s.data;l&&this.log_(l),this.onClosed_()}}start(){}static forceDisallow(){Dn.forceDisallow_=!0}static isAvailable(){let e=!1;if(typeof navigator<"u"&&navigator.userAgent){const t=/Android ([0-9]{0,}\.[0-9]{0,})/,s=navigator.userAgent.match(t);s&&s.length>1&&parseFloat(s[1])<4.4&&(e=!0)}return!e&&Xu!==null&&!Dn.forceDisallow_}static previouslyFailed(){return Qi.isInMemoryStorage||Qi.get("previous_websocket_failure")===!0}markConnectionHealthy(){Qi.remove("previous_websocket_failure")}appendFrame_(e){if(this.frames.push(e),this.frames.length===this.totalFrames){const t=this.frames.join("");this.frames=null;const s=Wl(t);this.onMessage(s)}}handleNewFrameCount_(e){this.totalFrames=e,this.frames=[]}extractFrameCount_(e){if(J(this.frames===null,"We already have a frame buffer"),e.length<=6){const t=Number(e);if(!isNaN(t))return this.handleNewFrameCount_(t),null}return this.handleNewFrameCount_(1),e}handleIncomingFrame(e){if(this.mySock===null)return;const t=e.data;if(this.bytesReceived+=t.length,this.stats_.incrementCounter("bytes_received",t.length),this.resetKeepAlive(),this.frames!==null)this.appendFrame_(t);else{const s=this.extractFrameCount_(t);s!==null&&this.appendFrame_(s)}}send(e){this.resetKeepAlive();const t=St(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const s=sv(t,yC);s.length>1&&this.sendString_(String(s.length));for(let l=0;l<s.length;l++)this.sendString_(s[l])}shutdown_(){this.isClosed_=!0,this.keepaliveTimer&&(clearInterval(this.keepaliveTimer),this.keepaliveTimer=null),this.mySock&&(this.mySock.close(),this.mySock=null)}onClosed_(){this.isClosed_||(this.log_("WebSocket is closing itself"),this.shutdown_(),this.onDisconnect&&(this.onDisconnect(this.everConnected_),this.onDisconnect=null))}close(){this.isClosed_||(this.log_("WebSocket is being closed"),this.shutdown_())}resetKeepAlive(){clearInterval(this.keepaliveTimer),this.keepaliveTimer=setInterval(()=>{this.mySock&&this.sendString_("0"),this.resetKeepAlive()},Math.floor(vC))}sendString_(e){try{this.mySock.send(e)}catch(t){this.log_("Exception thrown from WebSocket.send():",t.message||t.data,"Closing connection."),setTimeout(this.onClosed_.bind(this),0)}}}Dn.responsesRequiredToBeHealthy=2;Dn.healthyTimeout=3e4;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ju extends Cv{static getInstance(){return new Ju}constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!sf()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}getInitialEvent(e){return J(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xc{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const s=new Ce(vo,e),l=new Ce(vo,t);return this.compare(s,l)!==0}minPost(){return Ce.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Au;class Tv extends xc{static get __EMPTY_NODE(){return Au}static set __EMPTY_NODE(e){Au=e}compare(e,t){return ds(e.name,t.name)}isDefinedOn(e){throw Co("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return Ce.MIN}maxPost(){return new Ce(is,Au)}makePost(e,t){return J(typeof e=="string","KeyIndex indexValue must always be a string."),new Ce(e,Au)}toString(){return".key"}}const po=new Tv;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const BC=Math.log(2);class WC{constructor(e){const t=u=>parseInt(Math.log(u)/BC,10),s=u=>parseInt(Array(u+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const l=s(this.count);this.bits_=e+1&l}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const Zu=function(r,e,t,s){r.sort(e);const l=function(_,w){const N=w-_;let k,I;if(N===0)return null;if(N===1)return k=r[_],I=t?t(k):k,new xt(I,k.node,xt.BLACK,null,null);{const z=parseInt(N/2,10)+_,H=l(_,z),Y=l(z+1,w);return k=r[z],I=t?t(k):k,new xt(I,k.node,xt.BLACK,H,Y)}},u=function(_){let w=null,N=null,k=r.length;const I=function(H,Y){const W=k-H,me=k;k-=H;const $=l(W+1,me),ae=r[W],ce=t?t(ae):ae;z(new xt(ce,ae.node,Y,null,$))},z=function(H){w?(w.left=H,w=H):(N=H,w=H)};for(let H=0;H<_.count;++H){const Y=_.nextBitIsOne(),W=Math.pow(2,_.count-(H+1));Y?I(W,xt.BLACK):(I(W,xt.BLACK),I(W,xt.RED))}return N},h=new WC(r.length),m=u(h);return new Xt(s||e,m)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let _d;const so={};class kr{static get Default(){return J(so&&st,"ChildrenNode.ts has not been loaded"),_d=_d||new kr({".priority":so},{".priority":st}),_d}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=_o(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof Xt?t:null}hasIndex(e){return rr(this.indexSet_,e.toString())}addIndex(e,t){J(e!==po,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let l=!1;const u=t.getIterator(Ce.Wrap);let h=u.getNext();for(;h;)l=l||e.isDefinedOn(h.node),s.push(h),h=u.getNext();let m;l?m=Zu(s,e.getCompare()):m=so;const _=e.toString(),w=Object.assign({},this.indexSet_);w[_]=e;const N=Object.assign({},this.indexes_);return N[_]=m,new kr(N,w)}addToIndexes(e,t){const s=Bu(this.indexes_,(l,u)=>{const h=_o(this.indexSet_,u);if(J(h,"Missing index implementation for "+u),l===so)if(h.isDefinedOn(e.node)){const m=[],_=t.getIterator(Ce.Wrap);let w=_.getNext();for(;w;)w.name!==e.name&&m.push(w),w=_.getNext();return m.push(e),Zu(m,h.getCompare())}else return so;else{const m=t.get(e.name);let _=l;return m&&(_=_.remove(new Ce(e.name,m))),_.insert(e,e.node)}});return new kr(s,this.indexSet_)}removeFromIndexes(e,t){const s=Bu(this.indexes_,l=>{if(l===so)return l;{const u=t.get(e.name);return u?l.remove(new Ce(e.name,u)):l}});return new kr(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qC extends xc{constructor(e){super(),this.indexPath_=e,J(!ke(e)&&Ie(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const s=this.extractChild(e.node),l=this.extractChild(t.node),u=s.compareTo(l);return u===0?ds(e.name,t.name):u}makePost(e,t){const s=At(e),l=ge.EMPTY_NODE.updateChild(this.indexPath_,s);return new Ce(t,l)}maxPost(){const e=ge.EMPTY_NODE.updateChild(this.indexPath_,ua);return new Ce(is,e)}toString(){return Yl(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class KC extends xc{compare(e,t){const s=e.node.compareTo(t.node);return s===0?ds(e.name,t.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return Ce.MIN}maxPost(){return Ce.MAX}makePost(e,t){const s=At(e);return new Ce(t,s)}toString(){return".value"}}const YC=new KC;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ec extends Sv{reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return t!==void 0?"tag$"+t:(J(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}constructor(e,t,s,l){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=s,this.appCheckTokenProvider_=l,this.log_=aa("p:rest:"),this.listens_={}}listen(e,t,s,l){const u=e._path.toString();this.log_("Listen called for "+u+" "+e._queryIdentifier);const h=ec.getListenId_(e,s),m={};this.listens_[h]=m;const _=w_(e._queryParams);this.restRequest_(u+".json",_,(w,N)=>{let k=N;if(w===404&&(k=null,w=null),w===null&&this.onDataUpdate_(u,k,!1,s),_o(this.listens_,h)===m){let I;w?w===401?I="permission_denied":I="rest_error:"+w:I="ok",l(I,null)}})}unlisten(e,t){const s=ec.getListenId_(e,t);delete this.listens_[s]}get(e){const t=w_(e._queryParams),s=e._path.toString(),l=new pc;return this.restRequest_(s+".json",t,(u,h)=>{let m=h;u===404&&(m=null,u=null),u===null?(this.onDataUpdate_(s,m,!1,null),l.resolve(m)):l.reject(new Error(m))}),l.promise}refreshAuthToken(e){}restRequest_(e,t={},s){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([l,u])=>{l&&l.accessToken&&(t.auth=l.accessToken),u&&u.token&&(t.ac=u.token);const h=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+Io(t);this.log_("Sending REST request for "+h);const m=new XMLHttpRequest;m.onreadystatechange=()=>{if(s&&m.readyState===4){this.log_("REST Response for "+h+" received. status:",m.status,"response:",m.responseText);let _=null;if(m.status>=200&&m.status<300){try{_=Wl(m.responseText)}catch{Jt("Failed to parse JSON response for "+h+": "+m.responseText)}s(null,_)}else m.status!==401&&m.status!==404&&Jt("Got unsuccessful REST response for "+h+" Status: "+m.status),s(m.status);s=null}},m.open("GET",h,!0),m.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ZC{constructor(){this.rootNode_=ge.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tc(){return{value:null,children:new Map}}function Dv(r,e,t){if(ke(e))r.value=t,r.children.clear();else if(r.value!==null)r.value=r.value.updateChild(e,t);else{const s=Ie(e);r.children.has(s)||r.children.set(s,tc());const l=r.children.get(s);e=Ye(e),Dv(l,e,t)}}function Fd(r,e,t){r.value!==null?t(e,r.value):eI(r,(s,l)=>{const u=new He(e.toString()+"/"+s);Fd(l,u,t)})}function eI(r,e){r.children.forEach((t,s)=>{e(s,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nc{constructor(e,t,s){this.path=e,this.affectedTree=t,this.revert=s,this.type=Ln.ACK_USER_WRITE,this.source=Rf()}operationForChild(e){if(ke(this.path)){if(this.affectedTree.value!=null)return J(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new He(e));return new nc(Ue(),t,this.revert)}}else return J(Ie(this.path)===e,"operationForChild called for unrelated child."),new nc(Ye(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sc(r,e){return{eventCache:r,serverCache:e}}function Fl(r,e,t,s){return Sc(new os(e,t,s),r.serverCache)}function Ov(r,e,t,s){return Sc(r.eventCache,new os(e,t,s))}function Ud(r){return r.eventCache.isFullyInitialized()?r.eventCache.getNode():null}function ls(r){return r.serverCache.isFullyInitialized()?r.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kI(r){return{filter:r}}function TI(r,e){J(e.eventCache.getNode().isIndexed(r.filter.getIndex()),"Event snap not indexed"),J(e.serverCache.getNode().isIndexed(r.filter.getIndex()),"Server snap not indexed")}function NI(r,e,t,s,l){const u=new CI;let h,m;if(t.type===Ln.OVERWRITE){const w=t;w.source.fromUser?h=Bd(r,e,w.path,w.snap,s,l,u):(J(w.source.fromServer,"Unknown source."),m=w.source.tagged||e.serverCache.isFiltered()&&!ke(w.path),h=sc(r,e,w.path,w.snap,s,l,m,u))}else if(t.type===Ln.MERGE){const w=t;w.source.fromUser?h=AI(r,e,w.path,w.children,s,l,u):(J(w.source.fromServer,"Unknown source."),m=w.source.tagged||e.serverCache.isFiltered(),h=Wd(r,e,w.path,w.children,s,l,m,u))}else if(t.type===Ln.ACK_USER_WRITE){const w=t;w.revert?h=DI(r,e,w.path,s,l,u):h=PI(r,e,w.path,w.affectedTree,s,l,u)}else if(t.type===Ln.LISTEN_COMPLETE)h=bI(r,e,t.path,s,u);else throw Co("Unknown operation type: "+t.type);const _=u.getChanges();return RI(e,h,_),{viewCache:h,changes:_}}function RI(r,e,t){const s=e.eventCache;if(s.isFullyInitialized()){const l=s.getNode().isLeafNode()||s.getNode().isEmpty(),u=Ud(r);(t.length>0||!r.eventCache.isFullyInitialized()||l&&!s.getNode().equals(u)||!s.getNode().getPriority().equals(u.getPriority()))&&t.push(bv(Ud(e)))}}function zv(r,e,t,s,l,u){const h=e.eventCache;if(ic(s,t)!=null)return e;{let m,_;if(ke(t))if(J(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const w=ls(e),N=w instanceof ge?w:ge.EMPTY_NODE,k=Df(s,N);m=r.filter.updateFullNode(e.eventCache.getNode(),k,u)}else{const w=rc(s,ls(e));m=r.filter.updateFullNode(e.eventCache.getNode(),w,u)}else{const w=Ie(t);if(w===".priority"){J(_i(t)===1,"Can't have a priority with additional path components");const N=h.getNode();_=e.serverCache.getNode();const k=I_(s,t,N,_);k!=null?m=r.filter.updatePriority(N,k):m=h.getNode()}else{const N=Ye(t);let k;if(h.isCompleteForChild(w)){_=e.serverCache.getNode();const I=I_(s,t,h.getNode(),_);I!=null?k=h.getNode().getImmediateChild(w).updateChild(N,I):k=h.getNode().getImmediateChild(w)}else k=Of(s,w,e.serverCache);k!=null?m=r.filter.updateChild(h.getNode(),w,k,N,l,u):m=h.getNode()}}return Fl(e,m,h.isFullyInitialized()||ke(t),r.filter.filtersNodes())}}function sc(r,e,t,s,l,u,h,m){const _=e.serverCache;let w;const N=h?r.filter:r.filter.getIndexedFilter();if(ke(t))w=N.updateFullNode(_.getNode(),s,null);else if(N.filtersNodes()&&!_.isFiltered()){const z=_.getNode().updateChild(t,s);w=N.updateFullNode(_.getNode(),z,null)}else{const z=Ie(t);if(!_.isCompleteForPath(t)&&_i(t)>1)return e;const H=Ye(t),W=_.getNode().getImmediateChild(z).updateChild(H,s);z===".priority"?w=N.updatePriority(_.getNode(),W):w=N.updateChild(_.getNode(),z,W,H,Vv,null)}const k=Ov(e,w,_.isFullyInitialized()||ke(t),N.filtersNodes()),I=new Lf(l,k,u);return zv(r,k,t,l,I,m)}function Bd(r,e,t,s,l,u,h){const m=e.eventCache;let _,w;const N=new Lf(l,e,u);if(ke(t))w=r.filter.updateFullNode(e.eventCache.getNode(),s,h),_=Fl(e,w,!0,r.filter.filtersNodes());else{const k=Ie(t);if(k===".priority")w=r.filter.updatePriority(e.eventCache.getNode(),s),_=Fl(e,w,m.isFullyInitialized(),m.isFiltered());else{const I=Ye(t),z=m.getNode().getImmediateChild(k);let H;if(ke(I))H=s;else{const Y=N.getCompleteChild(k);Y!=null?Sf(I)===".priority"&&Y.getChild(Iv(I)).isEmpty()?H=Y:H=Y.updateChild(I,s):H=ge.EMPTY_NODE}if(z.equals(H))_=e;else{const Y=r.filter.updateChild(m.getNode(),k,H,I,N,h);_=Fl(e,Y,m.isFullyInitialized(),r.filter.filtersNodes())}}}return _}function k_(r,e){return r.eventCache.isCompleteForChild(e)}function AI(r,e,t,s,l,u,h){let m=e;return s.foreach((_,w)=>{const N=it(t,_);k_(e,Ie(N))&&(m=Bd(r,m,N,w,l,u,h))}),s.foreach((_,w)=>{const N=it(t,_);k_(e,Ie(N))||(m=Bd(r,m,N,w,l,u,h))}),m}function T_(r,e,t){return t.foreach((s,l)=>{e=e.updateChild(s,l)}),e}function Wd(r,e,t,s,l,u,h,m){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let _=e,w;ke(t)?w=s:w=new qe(null).setTree(t,s);const N=e.serverCache.getNode();return w.children.inorderTraversal((k,I)=>{if(N.hasChild(k)){const z=e.serverCache.getNode().getImmediateChild(k),H=T_(r,z,I);_=sc(r,_,new He(k),H,l,u,h,m)}}),w.children.inorderTraversal((k,I)=>{const z=!e.serverCache.isCompleteForChild(k)&&I.value===null;if(!N.hasChild(k)&&!z){const H=e.serverCache.getNode().getImmediateChild(k),Y=T_(r,H,I);_=sc(r,_,new He(k),Y,l,u,h,m)}}),_}function PI(r,e,t,s,l,u,h){if(ic(l,t)!=null)return e;const m=e.serverCache.isFiltered(),_=e.serverCache;if(s.value!=null){if(ke(t)&&_.isFullyInitialized()||_.isCompleteForPath(t))return sc(r,e,t,_.getNode().getChild(t),l,u,m,h);if(ke(t)){let w=new qe(null);return _.getNode().forEachChild(po,(N,k)=>{w=w.set(new He(N),k)}),Wd(r,e,t,w,l,u,m,h)}else return e}else{let w=new qe(null);return s.foreach((N,k)=>{const I=it(t,N);_.isCompleteForPath(I)&&(w=w.set(N,_.getNode().getChild(I)))}),Wd(r,e,t,w,l,u,m,h)}}function bI(r,e,t,s,l){const u=e.serverCache,h=Ov(e,u.getNode(),u.isFullyInitialized()||ke(t),u.isFiltered());return zv(r,h,t,s,Vv,l)}function DI(r,e,t,s,l,u){let h;if(ic(s,t)!=null)return e;{const m=new Lf(s,e,l),_=e.eventCache.getNode();let w;if(ke(t)||Ie(t)===".priority"){let N;if(e.serverCache.isFullyInitialized())N=rc(s,ls(e));else{const k=e.serverCache.getNode();J(k instanceof ge,"serverChildren would be complete if leaf node"),N=Df(s,k)}N=N,w=r.filter.updateFullNode(_,N,u)}else{const N=Ie(t);let k=Of(s,N,e.serverCache);k==null&&e.serverCache.isCompleteForChild(N)&&(k=_.getImmediateChild(N)),k!=null?w=r.filter.updateChild(_,N,k,Ye(t),m,u):e.eventCache.getNode().hasChild(N)?w=r.filter.updateChild(_,N,ge.EMPTY_NODE,Ye(t),m,u):w=_,w.isEmpty()&&e.serverCache.isFullyInitialized()&&(h=rc(s,ls(e)),h.isLeafNode()&&(w=r.filter.updateFullNode(w,h,u)))}return h=e.serverCache.isFullyInitialized()||ic(s,Ue())!=null,Fl(e,w,h,r.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let oc;class UI{constructor(){this.views=new Map}}function VI(r){J(!oc,"__referenceConstructor has already been defined"),oc=r}function zI(){return J(oc,"Reference.ts has not been loaded"),oc}function HI(r){return r.views.size===0}function Mf(r,e,t,s){const l=e.source.queryId;if(l!==null){const u=r.views.get(l);return J(u!=null,"SyncTree gave us an op for an invalid query."),A_(u,e,t,s)}else{let u=[];for(const h of r.views.values())u=u.concat(A_(h,e,t,s));return u}}function BI(r,e,t,s,l){const u=e._queryIdentifier,h=r.views.get(u);if(!h){let m=rc(t,l?s:null),_=!1;m?_=!0:s instanceof ge?(m=Df(t,s),_=!1):(m=ge.EMPTY_NODE,_=!1);const w=Sc(new os(m,_,!1),new os(s,l,!1));return new OI(e,w)}return h}function WI(r,e,t,s,l,u){const h=BI(r,e,s,l,u);return r.views.has(e._queryIdentifier)||r.views.set(e._queryIdentifier,h),jI(h,t),FI(h,t)}function $I(r,e,t,s){const l=e._queryIdentifier,u=[];let h=[];const m=yi(r);if(l==="default")for(const[_,w]of r.views.entries())h=h.concat(R_(w,t,s)),N_(w)&&(r.views.delete(_),w.query._queryParams.loadsAllData()||u.push(w.query));else{const _=r.views.get(l);_&&(h=h.concat(R_(_,t,s)),N_(_)&&(r.views.delete(l),_.query._queryParams.loadsAllData()||u.push(_.query)))}return m&&!yi(r)&&u.push(new(zI())(e._repo,e._path)),{removed:u,events:h}}function Bv(r){const e=[];for(const t of r.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function mo(r,e){let t=null;for(const s of r.views.values())t=t||MI(s,e);return t}function Wv(r,e){if(e._queryParams.loadsAllData())return Cc(r);{const s=e._queryIdentifier;return r.views.get(s)}}function $v(r,e){return Wv(r,e)!=null}function yi(r){return Cc(r)!=null}function Cc(r){for(const e of r.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let lc;function GI(r){J(!lc,"__referenceConstructor has already been defined"),lc=r}function qI(){return J(lc,"Reference.ts has not been loaded"),lc}let KI=1;class P_{constructor(e){this.listenProvider_=e,this.syncPointTree_=new qe(null),this.pendingWriteTree_=xI(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function YI(r,e,t,s,l){return cI(r.pendingWriteTree_,e,t,s,l),l?No(r,new ss(Rf(),e,t)):[]}function QI(r,e,t,s){hI(r.pendingWriteTree_,e,t,s);const l=qe.fromObject(t);return No(r,new Eo(Rf(),e,l))}function Xi(r,e,t=!1){const s=dI(r.pendingWriteTree_,e);if(fI(r.pendingWriteTree_,e)){let u=new qe(null);return s.snap!=null?u=u.set(Ue(),!0):Pt(s.children,h=>{u=u.set(new He(h),!0)}),No(r,new nc(s.path,u,t))}else return[]}function Ic(r,e,t){return No(r,new ss(Af(),e,t))}function XI(r,e,t){const s=qe.fromObject(t);return No(r,new Eo(Af(),e,s))}function JI(r,e){return No(r,new Zl(Af(),e))}function ZI(r,e,t){const s=jf(r,t);if(s){const l=Ff(s),u=l.path,h=l.queryId,m=Qt(u,e),_=new Zl(Pf(h),m);return Uf(r,u,_)}else return[]}function $d(r,e,t,s,l=!1){const u=e._path,h=r.syncPointTree_.get(u);let m=[];if(h&&(e._queryIdentifier==="default"||$v(h,e))){const _=$I(h,e,t,s);HI(h)&&(r.syncPointTree_=r.syncPointTree_.remove(u));const w=_.removed;if(m=_.events,!l){const N=w.findIndex(I=>I._queryParams.loadsAllData())!==-1,k=r.syncPointTree_.findOnPath(u,(I,z)=>yi(z));if(N&&!k){const I=r.syncPointTree_.subtree(u);if(!I.isEmpty()){const z=nk(I);for(let H=0;H<z.length;++H){const Y=z[H],W=Y.query,me=Yv(r,Y);r.listenProvider_.startListening(Vl(W),ac(r,W),me.hashFn,me.onComplete)}}}!k&&w.length>0&&!s&&(N?r.listenProvider_.stopListening(Vl(e),null):w.forEach(I=>{const z=r.queryToTagMap.get(kc(I));r.listenProvider_.stopListening(Vl(I),z)}))}rk(r,w)}return m}function ek(r,e,t,s){const l=jf(r,s);if(l!=null){const u=Ff(l),h=u.path,m=u.queryId,_=Qt(h,e),w=new ss(Pf(m),_,t);return Uf(r,h,w)}else return[]}function tk(r,e,t,s){const l=jf(r,s);if(l){const u=Ff(l),h=u.path,m=u.queryId,_=Qt(h,e),w=qe.fromObject(t),N=new Eo(Pf(m),_,w);return Uf(r,h,N)}else return[]}function b_(r,e,t,s=!1){const l=e._path;let u=null,h=!1;r.syncPointTree_.foreachOnPath(l,(I,z)=>{const H=Qt(I,l);u=u||mo(z,H),h=h||yi(z)});let m=r.syncPointTree_.get(l);m?(h=h||yi(m),u=u||mo(m,Ue())):(m=new UI,r.syncPointTree_=r.syncPointTree_.set(l,m));let _;u!=null?_=!0:(_=!1,u=ge.EMPTY_NODE,r.syncPointTree_.subtree(l).foreachChild((z,H)=>{const Y=mo(H,Ue());Y&&(u=u.updateImmediateChild(z,Y))}));const w=$v(m,e);if(!w&&!e._queryParams.loadsAllData()){const I=kc(e);J(!r.queryToTagMap.has(I),"View does not exist, but we have a tag");const z=ik();r.queryToTagMap.set(I,z),r.tagToQueryMap.set(z,I)}const N=bf(r.pendingWriteTree_,l);let k=WI(m,e,t,N,u,_);if(!w&&!h&&!s){const I=Wv(m,e);k=k.concat(sk(r,e,I))}return k}function Gv(r,e,t){const l=r.pendingWriteTree_,u=r.syncPointTree_.findOnPath(e,(h,m)=>{const _=Qt(h,e),w=mo(m,_);if(w)return w});return jv(l,e,u,t,!0)}function No(r,e){return qv(e,r.syncPointTree_,null,bf(r.pendingWriteTree_,Ue()))}function qv(r,e,t,s){if(ke(r.path))return Kv(r,e,t,s);{const l=e.get(Ue());t==null&&l!=null&&(t=mo(l,Ue()));let u=[];const h=Ie(r.path),m=r.operationForChild(h),_=e.children.get(h);if(_&&m){const w=t?t.getImmediateChild(h):null,N=Fv(s,h);u=u.concat(qv(m,_,w,N))}return l&&(u=u.concat(Mf(l,r,s,t))),u}}function Kv(r,e,t,s){const l=e.get(Ue());t==null&&l!=null&&(t=mo(l,Ue()));let u=[];return e.children.inorderTraversal((h,m)=>{const _=t?t.getImmediateChild(h):null,w=Fv(s,h),N=r.operationForChild(h);N&&(u=u.concat(Kv(N,m,_,w)))}),l&&(u=u.concat(Mf(l,r,s,t))),u}function Yv(r,e){const t=e.query,s=ac(r,t);return{hashFn:()=>(LI(e)||ge.EMPTY_NODE).hash(),onComplete:l=>{if(l==="ok")return s?ZI(r,t._path,s):JI(r,t._path);{const u=QS(l,t);return $d(r,t,null,u)}}}}function ac(r,e){const t=kc(e);return r.queryToTagMap.get(t)}function kc(r){return r._path.toString()+"$"+r._queryIdentifier}function jf(r,e){return r.tagToQueryMap.get(e)}function Ff(r){const e=r.indexOf("$");return J(e!==-1&&e<r.length-1,"Bad queryKey."),{queryId:r.substr(e+1),path:new He(r.substr(0,e))}}function Uf(r,e,t){const s=r.syncPointTree_.get(e);J(s,"Missing sync point for query tag that we're tracking");const l=bf(r.pendingWriteTree_,e);return Mf(s,t,l,null)}function nk(r){return r.fold((e,t,s)=>{if(t&&yi(t))return[Cc(t)];{let l=[];return t&&(l=Bv(t)),Pt(s,(u,h)=>{l=l.concat(h)}),l}})}function Vl(r){return r._queryParams.loadsAllData()&&!r._queryParams.isDefault()?new(qI())(r._repo,r._path):r}function rk(r,e){for(let t=0;t<e.length;++t){const s=e[t];if(!s._queryParams.loadsAllData()){const l=kc(s),u=r.queryToTagMap.get(l);r.queryToTagMap.delete(l),r.tagToQueryMap.delete(u)}}}function ik(){return KI++}function sk(r,e,t){const s=e._path,l=ac(r,e),u=Yv(r,t),h=r.listenProvider_.startListening(Vl(e),l,u.hashFn,u.onComplete),m=r.syncPointTree_.subtree(s);if(l)J(!yi(m.value),"If we're adding a query, it shouldn't be shadowed");else{const _=m.fold((w,N,k)=>{if(!ke(w)&&N&&yi(N))return[Cc(N).query];{let I=[];return N&&(I=I.concat(Bv(N).map(z=>z.query))),Pt(k,(z,H)=>{I=I.concat(H)}),I}});for(let w=0;w<_.length;++w){const N=_[w];r.listenProvider_.stopListening(Vl(N),ac(r,N))}}return h}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sk="repo_interrupt",Ck=25;class Ik{constructor(e,t,s,l){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=s,this.appCheckProvider_=l,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Ek,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=tc(),this.transactionQueueTree_=new Bf,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function kk(r,e,t){if(r.stats_=Ef(r.repoInfo_),r.forceRestClient_||eC())r.server_=new ec(r.repoInfo_,(s,l,u,h)=>{O_(r,s,l,u,h)},r.authTokenProvider_,r.appCheckProvider_),setTimeout(()=>L_(r,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{St(t)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}r.persistentConnection_=new Tr(r.repoInfo_,e,(s,l,u,h)=>{O_(r,s,l,u,h)},s=>{L_(r,s)},s=>{Nk(r,s)},r.authTokenProvider_,r.appCheckProvider_,t),r.server_=r.persistentConnection_}r.authTokenProvider_.addTokenChangeListener(s=>{r.server_.refreshAuthToken(s)}),r.appCheckProvider_.addTokenChangeListener(s=>{r.server_.refreshAppCheckToken(s.token)}),r.statsReporter_=sC(r.repoInfo_,()=>new iI(r.stats_,r.server_)),r.infoData_=new ZC,r.infoSyncTree_=new P_({startListening:(s,l,u,h)=>{let m=[];const _=r.infoData_.getNode(s._path);return _.isEmpty()||(m=Ic(r.infoSyncTree_,s._path,_),setTimeout(()=>{h("ok")},0)),m},stopListening:()=>{}}),Yf(r,"connected",!1),r.serverSyncTree_=new P_({startListening:(s,l,u,h)=>(r.server_.listen(s,u,l,(m,_)=>{const w=h(m,_);Pr(r.eventQueue_,s._path,w)}),[]),stopListening:(s,l)=>{r.server_.unlisten(s,l)}})}function Tk(r){const t=r.infoData_.getNode(new He(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function Kf(r){return ok({timestamp:Tk(r)})}function O_(r,e,t,s,l){r.dataUpdateCount++;const u=new He(e);t=r.interceptServerDataCallback_?r.interceptServerDataCallback_(e,t):t;let h=[];if(l)if(s){const _=Bu(t,w=>At(w));h=tk(r.serverSyncTree_,u,_,l)}else{const _=At(t);h=ek(r.serverSyncTree_,u,_,l)}else if(s){const _=Bu(t,w=>At(w));h=XI(r.serverSyncTree_,u,_)}else{const _=At(t);h=Ic(r.serverSyncTree_,u,_)}let m=u;h.length>0&&(m=ea(r,u)),Pr(r.eventQueue_,m,h)}function L_(r,e){Yf(r,"connected",e),e===!1&&Ak(r)}function Nk(r,e){Pt(e,(t,s)=>{Yf(r,t,s)})}function Yf(r,e,t){const s=new He("/.info/"+e),l=At(t);r.infoData_.updateSnapshot(s,l);const u=Ic(r.infoSyncTree_,s,l);Pr(r.eventQueue_,s,u)}function i0(r){return r.nextWriteId_++}function Rk(r,e,t,s){Qf(r,"update",{path:e.toString(),value:t});let l=!0;const u=Kf(r),h={};if(Pt(t,(m,_)=>{l=!1,h[m]=Qv(it(e,m),At(_),r.serverSyncTree_,u)}),l)Rt("update() called with empty data.  Don't do anything."),M_(r,s,"ok",void 0);else{const m=i0(r),_=QI(r.serverSyncTree_,e,h,m);qf(r.eventQueue_,_),r.server_.merge(e.toString(),t,(w,N)=>{const k=w==="ok";k||Jt("update at "+e+" failed: "+w);const I=Xi(r.serverSyncTree_,m,!k),z=I.length>0?ea(r,e):e;Pr(r.eventQueue_,z,I),M_(r,s,w,N)}),Pt(t,w=>{const N=u0(r,it(e,w));ea(r,N)}),Pr(r.eventQueue_,e,[])}}function Ak(r){Qf(r,"onDisconnectEvents");const e=Kf(r),t=tc();Fd(r.onDisconnect_,Ue(),(l,u)=>{const h=Qv(l,u,r.serverSyncTree_,e);Dv(t,l,h)});let s=[];Fd(t,Ue(),(l,u)=>{s=s.concat(Ic(r.serverSyncTree_,l,u));const h=u0(r,l);ea(r,h)}),r.onDisconnect_=tc(),Pr(r.eventQueue_,Ue(),s)}function Pk(r,e,t){let s;Ie(e._path)===".info"?s=b_(r.infoSyncTree_,e,t):s=b_(r.serverSyncTree_,e,t),n0(r.eventQueue_,e._path,s)}function bk(r,e,t){let s;Ie(e._path)===".info"?s=$d(r.infoSyncTree_,e,t):s=$d(r.serverSyncTree_,e,t),n0(r.eventQueue_,e._path,s)}function Dk(r){r.persistentConnection_&&r.persistentConnection_.interrupt(Sk)}function Qf(r,...e){let t="";r.persistentConnection_&&(t=r.persistentConnection_.id+":"),Rt(t,...e)}function M_(r,e,t,s){e&&To(()=>{if(t==="ok")e(null);else{const l=(t||"error").toUpperCase();let u=l;s&&(u+=": "+s);const h=new Error(u);h.code=l,e(h)}})}function s0(r,e,t){return Gv(r.serverSyncTree_,e,t)||ge.EMPTY_NODE}function Xf(r,e=r.transactionQueueTree_){if(e||Nc(r,e),Ro(e)){const t=l0(r,e);J(t.length>0,"Sending zero length transaction queue"),t.every(l=>l.status===0)&&Ok(r,ca(e),t)}else Jv(e)&&Tc(e,t=>{Xf(r,t)})}function Ok(r,e,t){const s=t.map(w=>w.currentWriteId),l=s0(r,e,s);let u=l;const h=l.hash();for(let w=0;w<t.length;w++){const N=t[w];J(N.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),N.status=1,N.retryCount++;const k=Qt(e,N.path);u=u.updateChild(k,N.currentOutputSnapshotRaw)}const m=u.val(!0),_=e;r.server_.put(_.toString(),m,w=>{Qf(r,"transaction put response",{path:_.toString(),status:w});let N=[];if(w==="ok"){const k=[];for(let I=0;I<t.length;I++)t[I].status=2,N=N.concat(Xi(r.serverSyncTree_,t[I].currentWriteId)),t[I].onComplete&&k.push(()=>t[I].onComplete(null,!0,t[I].currentOutputSnapshotResolved)),t[I].unwatcher();Nc(r,Wf(r.transactionQueueTree_,e)),Xf(r,r.transactionQueueTree_),Pr(r.eventQueue_,e,N);for(let I=0;I<k.length;I++)To(k[I])}else{if(w==="datastale")for(let k=0;k<t.length;k++)t[k].status===3?t[k].status=4:t[k].status=0;else{Jt("transaction at "+_.toString()+" failed: "+w);for(let k=0;k<t.length;k++)t[k].status=4,t[k].abortReason=w}ea(r,e)}},h)}function ea(r,e){const t=o0(r,e),s=ca(t),l=l0(r,t);return Lk(r,l,s),s}function Lk(r,e,t){if(e.length===0)return;const s=[];let l=[];const h=e.filter(m=>m.status===0).map(m=>m.currentWriteId);for(let m=0;m<e.length;m++){const _=e[m],w=Qt(t,_.path);let N=!1,k;if(J(w!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),_.status===4)N=!0,k=_.abortReason,l=l.concat(Xi(r.serverSyncTree_,_.currentWriteId,!0));else if(_.status===0)if(_.retryCount>=Ck)N=!0,k="maxretry",l=l.concat(Xi(r.serverSyncTree_,_.currentWriteId,!0));else{const I=s0(r,_.path,h);_.currentInputSnapshot=I;const z=e[m].update(I.val());if(z!==void 0){Gf("transaction failed: Data returned ",z,_.path);let H=At(z);typeof z=="object"&&z!=null&&rr(z,".priority")||(H=H.updatePriority(I.getPriority()));const W=_.currentWriteId,me=Kf(r),$=uk(H,I,me);_.currentOutputSnapshotRaw=H,_.currentOutputSnapshotResolved=$,_.currentWriteId=i0(r),h.splice(h.indexOf(W),1),l=l.concat(YI(r.serverSyncTree_,_.path,$,_.currentWriteId,_.applyLocally)),l=l.concat(Xi(r.serverSyncTree_,W,!0))}else N=!0,k="nodata",l=l.concat(Xi(r.serverSyncTree_,_.currentWriteId,!0))}Pr(r.eventQueue_,t,l),l=[],N&&(e[m].status=2,function(I){setTimeout(I,Math.floor(0))}(e[m].unwatcher),e[m].onComplete&&(k==="nodata"?s.push(()=>e[m].onComplete(null,!1,e[m].currentInputSnapshot)):s.push(()=>e[m].onComplete(new Error(k),!1,null))))}Nc(r,r.transactionQueueTree_);for(let m=0;m<s.length;m++)To(s[m]);Xf(r,r.transactionQueueTree_)}function o0(r,e){let t,s=r.transactionQueueTree_;for(t=Ie(e);t!==null&&Ro(s)===void 0;)s=Wf(s,t),e=Ye(e),t=Ie(e);return s}function l0(r,e){const t=[];return a0(r,e,t),t.sort((s,l)=>s.order-l.order),t}function a0(r,e,t){const s=Ro(e);if(s)for(let l=0;l<s.length;l++)t.push(s[l]);Tc(e,l=>{a0(r,l,t)})}function Nc(r,e){const t=Ro(e);if(t){let s=0;for(let l=0;l<t.length;l++)t[l].status!==2&&(t[s]=t[l],s++);t.length=s,Xv(e,t.length>0?t:void 0)}Tc(e,s=>{Nc(r,s)})}function u0(r,e){const t=ca(o0(r,e)),s=Wf(r.transactionQueueTree_,e);return hk(s,l=>{wd(r,l)}),wd(r,s),Zv(s,l=>{wd(r,l)}),t}function wd(r,e){const t=Ro(e);if(t){const s=[];let l=[],u=-1;for(let h=0;h<t.length;h++)t[h].status===3||(t[h].status===1?(J(u===h-1,"All SENT items should be at beginning of queue."),u=h,t[h].status=3,t[h].abortReason="set"):(J(t[h].status===0,"Unexpected transaction status in abort"),t[h].unwatcher(),l=l.concat(Xi(r.serverSyncTree_,t[h].currentWriteId,!0)),t[h].onComplete&&s.push(t[h].onComplete.bind(null,new Error("set"),!1,null))));u===-1?Xv(e,void 0):t.length=u+1,Pr(r.eventQueue_,ca(e),l);for(let h=0;h<s.length;h++)To(s[h])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jf{constructor(e,t,s,l){this._repo=e,this._path=t,this._queryParams=s,this._orderByCalled=l}get key(){return ke(this._path)?null:Sf(this._path)}get ref(){return new wi(this._repo,this._path)}get _queryIdentifier(){const e=E_(this._queryParams),t=vf(e);return t==="{}"?"default":t}get _queryObject(){return E_(this._queryParams)}isEqual(e){if(e=Vn(e),!(e instanceof Jf))return!1;const t=this._repo===e._repo,s=Cf(this._path,e._path),l=this._queryIdentifier===e._queryIdentifier;return t&&s&&l}toJSON(){return this.toString()}toString(){return this._repo.toString()+NC(this._path)}}class wi extends Jf{constructor(e,t){super(e,t,new Nf,!1)}get parent(){const e=Iv(this._path);return e===null?null:new wi(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class uc{constructor(e,t,s){this._node=e,this.ref=t,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new He(e),s=qd(this.ref,e);return new uc(this._node.getChild(t),s,st)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,l)=>e(new uc(l,qd(this.ref,s),st)))}hasChild(e){const t=new He(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Ed(r,e){return r=Vn(r),r._checkNotDeleted("ref"),e!==void 0?qd(r._root,e):r._root}function qd(r,e){return r=Vn(r),Ie(r._path)===null?vk("child","path",e):t0("child","path",e),new wi(r._repo,it(r._path,e))}function F_(r,e){yk("update",e,r._path);const t=new pc;return Rk(r._repo,r._path,e,t.wrapCallback(()=>{})),t.promise}class Zf{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const s=t._queryParams.getIndex();return new Uk("value",this,new uc(e.snapshotNode,new wi(t._repo,t._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Vk(this,e,t):null}matches(e){return e instanceof Zf?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function Hk(r,e,t,s,l){const u=new zk(t,void 0),h=new Zf(u);return Pk(r._repo,r,h),()=>bk(r._repo,r,h)}function Bk(r,e,t,s){return Hk(r,"value",e)}VI(wi);GI(wi);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`}),f}function Br(a,f,g){e:{for(E in g){var E=!1;break e}E=!0}E||(g=dr(g),typeof a=="string"?g!=null&&encodeURIComponent(String(g)):Be(a,f,g))}function et(a){ct.call(this),this.headers=new Map,this.o=a||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}H(et,ct);var Lc=/^https?$/i,Xo=["POST","PUT"];r=et.prototype,r.Ha=function(a){this.J=a},r.ea=function(a,f,g,E){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);f=f?f.toUpperCase():"GET",this.D=a,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():vn.g(),this.v=this.o?vs(this.o):vs(vn),this.g.onreadystatechange=I(this.Ea,this);try{this.B=!0,this.g.open(f,String(a),!0),this.B=!1}catch(V){Di(this,V);return}if(a=g||"",g=new Map(this.headers),E)if(Object.getPrototypeOf(E)===Object.prototype)for(var M in E)g.set(M,E[M]);else if(typeof E.keys=="function"&&typeof E.get=="function")for(const V of E.keys())g.set(V,E.get(V));else throw Error("Unknown input type for opt_headers: "+String(E));E=Array.from(g.keys()).find(V=>V.toLowerCase()=="content-type"),M=m.FormData&&a instanceof m.FormData,!(0<=Array.prototype.indexOf.call(Xo,f,void 0))||E||M||g.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[V,Z]of g)this.g.setRequestHeader(V,Z);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{As(this),this.u=!0,this.g.send(a),this.u=!1}catch(V){Di(this,V)}};function Di(a,f){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=f,a.m=5,Rs(a),tn(a)}function Rs(a){a.A||(a.A=!0,ht(a,"complete"),ht(a,"error"))}r.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=a||7,ht(this,"complete"),ht(this,"abort"),tn(this))},r.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),tn(this,!0)),et.aa.N.call(this)},r.Ea=function(){this.s||(this.B||this.u||this.j?Jo(this):this.bb())},r.bb=function(){Jo(this)};function Jo(a){if(a.h&&typeof h<"u"&&(!a.v[1]||Ht(a)!=4||a.Z()!=2)){if(a.u&&Ht(a)==4)Oo(a.Ea,0,a);else if(ht(a,"readystatechange"),Ht(a)==4){a.h=!1;try{const Z=a.Z();e:switch(Z){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var f=!0;break e;default:f=!1}var g;if(!(g=f)){var E;if(E=Z===0){var M=String(a.D).match(Ai)[1]||null;!M&&m.self&&m.self.location&&(M=m.self.location.protocol.slice(0,-1)),E=!Lc.test(M?M.toLowerCase():"")}g=E}if(g)ht(a,"complete"),ht(a,"success");else{a.m=6;try{var V=2<Ht(a)?a.g.statusText:""}catch{V=""}a.l=V+" ["+a.Z()+"]",Rs(a)}}finally{tn(a)}}}}function tn(a,f){if(a.g){As(a);const g=a.g,E=a.v[0]?()=>{}:null;a.g=null,a.v=null,f||ht(a,"ready");try{g.onreadystatechange=E}catch{}}}function As(a){a.I&&(m.clearTimeout(a.I),a.I=null)}r.isActive=function(){return!!this.g};function Ht(a){return a.g?a.g.readyState:0}r.Z=function(){try{return 2<Ht(this)?this.g.status:-1}catch{return-1}},r.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},r.Oa=function(a){if(this.g){var f=this.g.responseText;return a&&f.indexOf(a)==0&&(f=f.substring(a.length)),Fo(f)}};function Zo(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.H){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function Ps(a){const f={};a=(a.g&&2<=Ht(a)&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let E=0;E<a.length;E++){if($(a[E]))continue;var g=A(a[E]);const M=g[0];if(g=g[1],typeof g!="string")continue;g=g.trim();const V=f[M]||[];f[M]=V,V.push(g)}P(f,function(E){return E.join(", ")})}r.Ba=function(){return this.m},r.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function Wn(a,f,g){return g&&g.internalChannelParams&&g.internalChannelParams[a]||f}function el(a){this.Aa=0,this.i=[],this.j=new Ii,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=Wn("failFast",!1,a),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=Wn("baseRetryDelayMs",5e3,a),this.cb=Wn("retryDelaySeedMs",1e4,a),this.Wa=Wn("forwardChannelMaxRetries",2,a),this.wa=Wn("forwardChannelRequestTimeoutMs",2e4,a),this.pa=a&&a.xmlHttpFactory||void 0,this.Xa=a&&a.Tb||void 0,this.Ca=a&&a.useFetchStreams||!1,this.L=void 0,this.J=a&&a.supportsCrossDomainXhr||!1,this.K="",this.h=new Ri(a&&a.concurrentRequestLimit),this.Da=new Oc,this.P=a&&a.fastHandshake||!1,this.O=a&&a.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=a&&a.Rb||!1,a&&a.xa&&this.j.xa(),a&&a.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&a&&a.detectBufferingProxy||!1,this.ja=void 0,a&&a.longPollingTimeout&&0<a.longPollingTimeout&&(this.ja=a.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}r=el.prototype,r.la=8,r.G=1,r.connect=function(a,f,g,E){ot(0),this.W=a,this.H=f||{},g&&E!==void 0&&(this.H.OSID=g,this.H.OAID=E),this.F=this.X,this.I=ba(this,null,this.W),$n(this)};function It(a){if(bs(a),a.G==3){var f=a.U++,g=en(a.I);if(Be(g,"SID",a.K),Be(g,"RID",f),Be(g,"TYPE","terminate"),fr(a,g),f=new wn(a,a.j,f),f.L=2,f.v=Vr(en(g)),g=!1,m.navigator&&m.navigator.sendBeacon)try{g=m.navigator.sendBeacon(f.v.toString(),"")}catch{}!g&&m.Image&&(new Image().src=f.v,g=!0),g||(f.g=Da(f.j,null),f.g.ea(f.v)),f.F=Date.now(),$e(f)}Pa(a)}function In(a){a.g&&(tl(a),a.g.cancel(),a.g=null)}function bs(a){In(a),a.u&&(m.clearTimeout(a.u),a.u=null),Ls(a),a.h.cancel(),a.s&&(typeof a.s=="number"&&m.clearTimeout(a.s),a.s=null)}function $n(a){if(!Zt(a.h)&&!a.s){a.s=!0;var f=a.Ga;Oe||ne(),ee||(Oe(),ee=!0),he.add(f,a),a.B=0}}function Mc(a,f){return va(a.h)>=a.h.j-(a.s?1:0)?!1:a.s?(a.i=f.D.concat(a.i),!0):a.G==1||a.G==2||a.B>=(a.Va?0:a.Wa)?!1:(a.s=_n(I(a.Ga,a,f),Aa(a,a.B)),a.B++,!0)}r.Ga=function(a){if(this.s)if(this.s=null,this.G==1){if(!a){this.U=Math.floor(1e5*Math.random()),a=this.U++;const M=new wn(this,this.j,a);let V=this.o;if(this.S&&(V?(V=x(V),R(V,this.S)):V=this.S),this.m!==null||this.O||(M.H=V,V=null),this.P)e:{for(var f=0,g=0;g<this.i.length;g++){t:{var E=this.i[g];if("__data__"in E.map&&(E=E.map.__data__,typeof E=="string")){E=E.length;break t}E=void 0}if(E===void 0)break;if(f+=E,4096<f){f=g;break e}if(f===4096||g===this.i.length-1){f=g+1;break e}}f=1e3}else f=1e3;f=Wr(this,M,f),g=en(this.I),Be(g,"RID",a),Be(g,"CVER",22),this.D&&Be(g,"X-HTTP-Session-Id",this.D),fr(this,g),V&&(this.O?f="headers="+encodeURIComponent(String(dr(V)))+"&"+f:this.m&&Br(g,this.m,V)),Yo(this.h,M),this.Ua&&Be(g,"TYPE","init"),this.P?(Be(g,"$req",f),Be(g,"SID","null"),M.T=!0,Is(M,g,null)):Is(M,g,f),this.G=2}}else this.G==3&&(a?Ds(this,a):this.i.length==0||Zt(this.h)||Ds(this))};function Ds(a,f){var g;f?g=f.l:g=a.U++;const E=en(a.I);Be(E,"SID",a.K),Be(E,"RID",g),Be(E,"AID",a.T),fr(a,E),a.m&&a.o&&Br(E,a.m,a.o),g=new wn(a,a.j,g,a.B+1),a.m===null&&(g.H=a.o),f&&(a.i=f.D.concat(a.i)),f=Wr(a,g,1e3),g.I=Math.round(.5*a.wa)+Math.round(.5*a.wa*Math.random()),Yo(a.h,g),Is(g,E,f)}function fr(a,f){a.H&&B(a.H,function(g,E){Be(f,E,g)}),a.l&&jr({},function(g,E){Be(f,E,g)})}function Wr(a,f,g){g=Math.min(a.i.length,g);var E=a.l?I(a.l.Na,a.l,a):null;e:{var M=a.i;let V=-1;for(;;){const Z=["count="+g];V==-1?0<g?(V=M[0].g,Z.push("ofs="+V)):V=0:Z.push("ofs="+V);let ze=!0;for(let dt=0;dt<g;dt++){let Re=M[dt].g;const gt=M[dt].map;if(Re-=V,0>Re)V=Math.max(0,M[dt].g-100),ze=!1;else try{Ta(gt,Z,"req"+Re+"_")}catch{E&&E(gt)}}if(ze){E=Z.join("&");break e}}}return a=a.i.splice(0,g),f.D=a,E}function Oi(a){if(!a.g&&!a.u){a.Y=1;var f=a.Fa;Oe||ne(),ee||(Oe(),ee=!0),he.add(f,a),a.v=0}}function Os(a){return a.g||a.u||3<=a.v?!1:(a.Y++,a.u=_n(I(a.Fa,a),Aa(a,a.v)),a.v++,!0)}r.Fa=function(){if(this.u=null,Ra(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var a=2*this.R;this.j.info("BP detection timer enabled: "+a),this.A=_n(I(this.ab,this),a)}},r.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,ot(10),In(this),Ra(this))};function tl(a){a.A!=null&&(m.clearTimeout(a.A),a.A=null)}function Ra(a){a.g=new wn(a,a.j,"rpc",a.Y),a.m===null&&(a.g.H=a.o),a.g.O=0;var f=en(a.qa);Be(f,"RID","rpc"),Be(f,"SID",a.K),Be(f,"AID",a.T),Be(f,"CI",a.F?"0":"1"),!a.F&&a.ja&&Be(f,"TO",a.ja),Be(f,"TYPE","xmlhttp"),fr(a,f),a.m&&a.o&&Br(f,a.m,a.o),a.L&&(a.g.I=a.L);var g=a.g;a=a.ia,g.L=1,g.v=Vr(en(f)),g.m=null,g.P=!0,qo(g,a)}r.Za=function(){this.C!=null&&(this.C=null,In(this),Os(this),ot(19))};function Ls(a){a.C!=null&&(m.clearTimeout(a.C),a.C=null)}function Ms(a,f){var g=null;if(a.g==f){Ls(a),tl(a),a.g=null;var E=2}else if(Mt(a.h,f))g=f.D,wa(a.h,f),E=1;else return;if(a.G!=0){if(f.o)if(E==1){g=f.m?f.m.length:0,f=Date.now()-f.F;var M=a.B;E=Es(),ht(E,new xs(E,g)),$n(a)}else Oi(a);else if(M=f.s,M==3||M==0&&0<f.X||!(E==1&&Mc(a,f)||E==2&&Os(a)))switch(g&&0<g.length&&(f=a.h,f.i=f.i.concat(g)),M){case 1:pr(a,5);break;case 4:pr(a,10);break;case 3:pr(a,6);break;default:pr(a,2)}}}function Aa(a,f){let g=a.Ta+Math.floor(Math.random()*a.cb);return a.isActive()||(g*=2),g*f}function pr(a,f){if(a.j.info("Error code "+f),f==2){var g=I(a.fb,a),E=a.Xa;const M=!E;E=new cr(E||"//www.google.com/images/cleardot.gif"),m.location&&m.location.protocol=="http"||Pi(E,"https"),Vr(E),M?Dc(E.toString(),g):ka(E.toString(),g)}else ot(2);a.G=0,a.l&&a.l.sa(f),Pa(a),bs(a)}r.fb=function(a){a?(this.j.info("Successfully pinged google.com"),ot(2)):(this.j.info("Failed to ping google.com"),ot(1))};function Pa(a){if(a.G=0,a.ka=[],a.l){const f=Ea(a.h);(f.length!=0||a.i.length!=0)&&(W(a.ka,f),W(a.ka,a.i),a.h.i.length=0,Y(a.i),a.i.length=0),a.l.ra()}}function ba(a,f,g){var E=g instanceof cr?en(g):new cr(g);if(E.g!="")f&&(E.g=f+"."+E.g),Fr(E,E.s);else{var M=m.location;E=M.protocol,f=f?f+"."+M.hostname:M.hostname,M=+M.port;var V=new cr(null);E&&Pi(V,E),f&&(V.g=f),M&&Fr(V,M),g&&(V.l=g),E=V}return g=a.D,f=a.ya,g&&f&&Be(E,g,f),Be(E,"VER",a.la),fr(a,E),E}function Da(a,f,g){if(f&&!a.J)throw Error("Can't create secondary domain capable XhrIo object.");return f=a.Ca&&!a.pa?new et(new hr({eb:g})):new et(a.pa),f.Ha(a.J),f}r.isActive=function(){return!!this.l&&this.l.isActive(this)};function nl(){}r=nl.prototype,r.ua=function(){},r.ta=function(){},r.sa=function(){},r.ra=function(){},r.isActive=function(){return!0},r.Na=function(){};function Bt(a,f){ct.call(this),this.g=new el(f),this.l=a,this.h=f&&f.messageUrlParams||null,a=f&&f.messageHeaders||null,f&&f.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=f&&f.initMessageHeaders||null,f&&f.messageContentType&&(a?a["X-WebChannel-Content-Type"]=f.messageContentType:a={"X-WebChannel-Content-Type":f.messageContentType}),f&&f.va&&(a?a["X-WebChannel-Client-Profile"]=f.va:a={"X-WebChannel-Client-Profile":f.va}),this.g.S=a,(a=f&&f.Sb)&&!$(a)&&(this.g.m=a),this.v=f&&f.supportsCrossDomainXhr||!1,this.u=f&&f.sendRawJson||!1,(f=f&&f.httpSessionIdParam)&&!$(f)&&(this.g.D=f,a=this.h,a!==null&&f in a&&(a=this.h,f in a&&delete a[f])),this.j=new $r(this)}H(Bt,ct),Bt.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Bt.prototype.close=function(){It(this.g)},Bt.prototype.o=function(a){var f=this.g;if(typeof a=="string"){var g={};g.__data__=a,a=g}else this.u&&(g={},g.__data__=jo(a),a=g);f.i.push(new ya(f.Ya++,a)),f.G==3&&$n(f)},Bt.prototype.N=function(){this.g.l=null,delete this.j,It(this.g),delete this.g,Bt.aa.N.call(this)};function Oa(a){zn.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var f=a.__sm__;if(f){e:{for(const g in f){a=g;break e}a=void 0}(this.i=a)&&(a=this.i,f=f!==null&&a in f?f[a]:void 0),this.data=f}else this.data=a}H(Oa,zn);function La(){ws.call(this),this.status=1}H(La,ws);function $r(a){this.g=a}H($r,nl),$r.prototype.ua=function(){ht(this.g,"a")},$r.prototype.ta=function(a){ht(this.g,new Oa(a))},$r.prototype.sa=function(a){ht(this.g,new La)},$r.prototype.ra=function(){ht(this.g,"b")},Bt.prototype.send=Bt.prototype.o,Bt.prototype.open=Bt.prototype.m,Bt.prototype.close=Bt.prototype.close,$o.NO_ERROR=0,$o.TIMEOUT=8,$o.HTTP_ERROR=6,Ac.COMPLETE="complete",Vo.EventType=on,on.OPEN="a",on.CLOSE="b",on.ERROR="c",on.MESSAGE="d",ct.prototype.listen=ct.prototype.K,et.prototype.listenOnce=et.prototype.L,et.prototype.getLastError=et.prototype.Ka,et.prototype.getLastErrorCode=et.prototype.Ba,et.prototype.getStatus=et.prototype.Z,et.prototype.getResponseJson=et.prototype.Oa,et.prototype.getResponseText=et.prototype.oa,et.prototype.send=et.prototype.ea,et.prototype.setWithCredentials=et.prototype.Ha}).apply(typeof bu<"u"?bu:typeof self<"u"?self:typeof window<"u"?window:{});const V_="@firebase/firestore",z_="4.8.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const So=new gc("@firebase/firestore");function Mn(r,...e){if(So.logLevel<=Fe.DEBUG){const t=e.map(tp);So.debug(`Firestore (${ha}): ${r}`,...t)}}function c0(r,...e){if(So.logLevel<=Fe.ERROR){const t=e.map(tp);So.error(`Firestore (${ha}): ${r}`,...t)}}function eT(r,...e){if(So.logLevel<=Fe.WARN){const t=e.map(tp);So.warn(`Firestore (${ha}): ${r}`,...t)}}function tp(r){if(typeof r=="string")return r;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ta(r,e,t){let s="Unexpected state";typeof e=="string"?s=e:t=e,h0(r,s,t)}function h0(r,e,t){let s=`FIRESTORE (${ha}) INTERNAL ASSERTION FAILED: ${e} (ID: ${r.toString(16)})`;if(t!==void 0)try{s+=" CONTEXT: "+JSON.stringify(t)}catch{s+=" CONTEXT: "+t}throw c0(s),new Error(s)}function zl(r,e,t,s){let l="Unexpected state";typeof t=="string"?l=t:s=t,r||h0(e,l,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ut(r,e){const t={typeString:r};return e&&(t.value=e),t}function da(r,e){if(!pT(r))throw new be(Pe.INVALID_ARGUMENT,"JSON must be an object");let t;for(const s in e)if(e[s]){const l=e[s].typeString,u="value"in e[s]?{value:e[s].value}:void 0;if(!(s in r)){t=`JSON missing required field: '${s}'`;break}const h=r[s];if(l&&typeof h!==l){t=`JSON field '${s}' must be a ${l}.`;break}if(u!==void 0&&h!==u.value){t=`Expected '${s}' field to equal '${u.value}'`;break}}if(t)throw new be(Pe.INVALID_ARGUMENT,t);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class as{constructor(e){this.binaryString=e}static fromBase64String(e){const t=function(l){try{return atob(l)}catch(u){throw typeof DOMException<"u"&&u instanceof DOMException?new yT("Invalid base64 string: "+u):u}}(e);return new as(t)}static fromUint8Array(e){const t=function(l){let u="";for(let h=0;h<l.length;++h)u+=String.fromCharCode(l[h]);return u}(e);return new as(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(t){return btoa(t)}(this.binaryString)}toUint8Array(){return function(t){const s=new Uint8Array(t.length);for(let l=0;l<t.length;l++)s[l]=t.charCodeAt(l);return s}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return Fn(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}as.EMPTY_BYTE_STRING=new as("");const Yd="(default)";class cc{constructor(e,t){this.projectId=e,this.database=t||Yd}static empty(){return new cc("","")}get isDefaultDatabase(){return this.database===Yd}isEqual(e){return e instanceof cc&&e.projectId===this.projectId&&e.database===this.database}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class es{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new be(Pe.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new be(Pe.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return Fn(this._lat,e._lat)||Fn(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:es._jsonSchemaVersion}}static fromJSON(e){if(da(e,es._jsonSchema))return new es(e.latitude,e.longitude)}}es._jsonSchemaVersion="firestore/geoPoint/1.0",es._jsonSchema={type:ut("string",es._jsonSchemaVersion),latitude:ut("number"),longitude:ut("number")};/**
 * @license
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const LT=r=>r.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),Ve=(r,e)=>{const t=le.forwardRef(({color:s="currentColor",size:l=24,strokeWidth:u=2,absoluteStrokeWidth:h,className:m="",children:_,...w},N)=>le.createElement("svg",{ref:N,...OT,width:l,height:l,stroke:s,strokeWidth:h?Number(u)*24/Number(l):u,className:["lucide",`lucide-${LT(r)}`,m].join(" "),...w},[...e.map(([k,I])=>le.createElement(k,I)),...Array.isArray(_)?_:[_]]));return t.displayName=`${r}`,t};/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const y0=Ve("AlertCircle",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["line",{x1:"12",x2:"12",y1:"8",y2:"12",key:"1pkeuh"}],["line",{x1:"12",x2:"12.01",y1:"16",y2:"16",key:"4dfq90"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qd=Ve("ArrowLeft",[["path",{d:"m12 19-7-7 7-7",key:"1l729n"}],["path",{d:"M19 12H5",key:"x3x0zl"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const MT=Ve("ArrowRight",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const jT=Ve("Bell",[["path",{d:"M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9",key:"1qo2s2"}],["path",{d:"M10.3 21a1.94 1.94 0 0 0 3.4 0",key:"qgo35s"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const FT=Ve("Calendar",[["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M16 2v4",key:"4m81vk"}],["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",key:"1hopcy"}],["path",{d:"M3 10h18",key:"8toen8"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ou=Ve("CheckSquare",[["path",{d:"m9 11 3 3L22 4",key:"1pflzl"}],["path",{d:"M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11",key:"1jnkn4"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const VT=Ve("ClipboardList",[["rect",{width:"8",height:"4",x:"8",y:"2",rx:"1",ry:"1",key:"tgr4d6"}],["path",{d:"M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2",key:"116196"}],["path",{d:"M12 11h4",key:"1jrz19"}],["path",{d:"M12 16h4",key:"n85exb"}],["path",{d:"M8 11h.01",key:"1dfujw"}],["path",{d:"M8 16h.01",key:"18s6g9"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const HT=Ve("EyeOff",[["path",{d:"M9.88 9.88a3 3 0 1 0 4.24 4.24",key:"1jxqfv"}],["path",{d:"M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68",key:"9wicm4"}],["path",{d:"M6.61 6.61A13.526 13.526 0 0 0 2 12s3 7 10 7a9.74 9.74 0 0 0 5.39-1.61",key:"1jreej"}],["line",{x1:"2",x2:"22",y1:"2",y2:"22",key:"a6p6uj"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const op=Ve("Eye",[["path",{d:"M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z",key:"rwhkz3"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const BT=Ve("Home",[["path",{d:"m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z",key:"y5dka4"}],["polyline",{points:"9 22 9 12 15 12 15 22",key:"e2us08"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const WT=Ve("LayoutDashboard",[["rect",{width:"7",height:"9",x:"3",y:"3",rx:"1",key:"10lvy0"}],["rect",{width:"7",height:"5",x:"14",y:"3",rx:"1",key:"16une8"}],["rect",{width:"7",height:"9",x:"14",y:"12",rx:"1",key:"1hutg5"}],["rect",{width:"7",height:"5",x:"3",y:"16",rx:"1",key:"ldoo1y"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $T=Ve("Loader2",[["path",{d:"M21 12a9 9 0 1 1-6.219-8.56",key:"13zald"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ry=Ve("Lock",[["rect",{width:"18",height:"11",x:"3",y:"11",rx:"2",ry:"2",key:"1w4ew1"}],["path",{d:"M7 11V7a5 5 0 0 1 10 0v4",key:"fwvmzm"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xd=Ve("LogOut",[["path",{d:"M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4",key:"1uf3rs"}],["polyline",{points:"16 17 21 12 16 7",key:"1gabdz"}],["line",{x1:"21",x2:"9",y1:"12",y2:"12",key:"1uyos4"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const v0=Ve("MapPin",[["path",{d:"M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z",key:"2oe9fu"}],["circle",{cx:"12",cy:"10",r:"3",key:"ilqhr7"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const qT=Ve("MessageSquare",[["path",{d:"M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z",key:"1lielz"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ao=Ve("Minus",[["path",{d:"M5 12h14",key:"1ays0h"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const iy=Ve("Package",[["path",{d:"m7.5 4.27 9 5.15",key:"1c824w"}],["path",{d:"M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z",key:"hh9hay"}],["path",{d:"m3.3 7 8.7 5 8.7-5",key:"g66t2b"}],["path",{d:"M12 22V12",key:"d0xqtd"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Zi=Ve("Plus",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"M12 5v14",key:"s699le"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const KT=Ve("QrCode",[["rect",{width:"5",height:"5",x:"3",y:"3",rx:"1",key:"1tu5fj"}],["rect",{width:"5",height:"5",x:"16",y:"3",rx:"1",key:"1v8r4q"}],["rect",{width:"5",height:"5",x:"3",y:"16",rx:"1",key:"1x03jg"}],["path",{d:"M21 16h-3a2 2 0 0 0-2 2v3",key:"177gqh"}],["path",{d:"M21 21v.01",key:"ents32"}],["path",{d:"M12 7v3a2 2 0 0 1-2 2H7",key:"8crl2c"}],["path",{d:"M3 12h.01",key:"nlz23k"}],["path",{d:"M12 3h.01",key:"n36tog"}],["path",{d:"M12 16v.01",key:"133mhm"}],["path",{d:"M16 12h1",key:"1slzba"}],["path",{d:"M21 12v.01",key:"1lwtk9"}],["path",{d:"M12 21v-1",key:"1880an"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const w0=Ve("Refrigerator",[["path",{d:"M5 6a4 4 0 0 1 4-4h6a4 4 0 0 1 4 4v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6Z",key:"fpq118"}],["path",{d:"M5 10h14",key:"elsbfy"}],["path",{d:"M15 7v6",key:"1nx30x"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const E0=Ve("Settings",[["path",{d:"M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z",key:"1qme2f"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const YT=Ve("User",[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const dc=Ve("Users",[["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",key:"1yyitq"}],["circle",{cx:"9",cy:"7",r:"4",key:"nufk8"}],["path",{d:"M22 21v-2a4 4 0 0 0-3-3.87",key:"kshegd"}],["path",{d:"M16 3.13a4 4 0 0 1 0 7.75",key:"1da9ce"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const na=Ve("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]),QT=({size:r="md",className:e=""})=>{const t={sm:"w-4 h-4",md:"w-6 h-6",lg:"w-8 h-8"};return y.jsx($T,{className:`animate-spin ${t[r]} ${e}`})},Ke=({variant:r="primary",size:e="md",loading:t=!1,children:s,className:l="",disabled:u,...h})=>{const m="inline-flex items-center justify-center rounded-lg font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed",_={primary:"bg-primary text-on-primary hover:bg-primary focus:ring-primary  shadow-md hover:shadow-lg",secondary:"bg-secondary text-on-secondary hover:bg-secondary focus:ring-secondary  shadow-md hover:shadow-lg",outline:"border border-default text-default hover:bg-subtle focus:ring-primary",ghost:"text-muted hover:text-default hover:bg-subtle focus:ring-default"},w={sm:"px-3 py-1.5 text-sm",md:"px-4 py-2 text-base",lg:"px-6 py-3 text-lg"};return y.jsxs("button",{className:`${m} ${_[r]} ${w[e]} ${l}`,disabled:u||t,...h,children:[t&&y.jsx(QT,{size:"sm",className:"mr-2"}),s]})},fc=le.forwardRef(({label:r,error:e,icon:t,className:s="",...l},u)=>y.jsxs("div",{className:"space-y-1",children:[r&&y.jsx("label",{className:"block text-sm font-medium text-default text-subtle",children:r}),y.jsxs("div",{className:"relative",children:[t&&y.jsx("div",{className:"absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none",children:y.jsx("div",{className:"text-muted ",children:t})}),y.jsx("input",{ref:u,className:`
              ...
              ${s}
            `,...l})]}),e&&y.jsx("p",{className:"text-sm text-red-600  mt-1",children:e})]}));fc.displayName="Input";const lp=r=>/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(r),XT=r=>r.length>=3&&/^[a-zA-Z0-9_]+$/.test(r),JT=r=>r.length>=6,sy=r=>lp(r)?"email":"username",ZT=({onForgotPassword:r})=>{const[e,t]=le.useState({emailOrUsername:"",password:"",rememberMe:!1}),[s,l]=le.useState({}),[u,h]=le.useState(!1),[m,_]=le.useState({}),{login:w,isLoading:N,error:k,clearError:I}=fa();le.useEffect(()=>{if(k){const $=setTimeout(()=>{I()},5e3);return()=>clearTimeout($)}},[k,I]);const z=()=>{const $={};if(!e.emailOrUsername.trim())$.emailOrUsername="Email or username is required";else{const ae=sy(e.emailOrUsername);ae==="email"&&!lp(e.emailOrUsername)?$.emailOrUsername="Please enter a valid email address":ae==="username"&&!XT(e.emailOrUsername)&&($.emailOrUsername="Username must be at least 3 characters and contain only letters, numbers, and underscores")}return e.password?JT(e.password)||($.password="Password must be at least 6 characters"):$.password="Password is required",l($),Object.keys($).length===0},H=async $=>{$.preventDefault(),z()&&await w(e)},Y=($,ae)=>{t(ce=>({...ce,[$]:ae})),m[$]&&l(ce=>({...ce,[$]:""}))},W=$=>{_(ae=>({...ae,[$]:!0})),z()},me=sy(e.emailOrUsername)==="email"?y.jsx(Jd,{size:20}):y.jsx(YT,{size:20});return y.jsx("div",{className:"min-h-screen bg-bg flex items-center justify-center p-3 sm:p-4",children:y.jsx("div",{className:"w-full max-w-sm sm:max-w-md",children:y.jsx("div",{className:"bg-bg rounded-2xl shadow-xl overflow-hidden border border-default",children:y.jsxs("div",{className:"px-6 sm:px-8 pt-6 sm:pt-8 pb-4 sm:pb-6",children:[y.jsxs("div",{className:"text-center mb-8",children:[y.jsx("div",{className:"inline-flex items-center justify-center w-16 h-16 bg-gradient-primary rounded-2xl mb-4",children:y.jsx(ry,{className:"w-8 h-8 text-on-primary"})}),y.jsx("h1",{className:"text-2xl sm:text-3xl font-bold text-default mb-2",children:"Welcome Back"}),y.jsx("p",{className:"text-subtle text-sm sm:text-base",children:"Sign in to your account to continue"})]}),k&&y.jsxs("div",{className:"mb-6 p-3 sm:p-4 bg-gradient-theme border border-error rounded-lg flex items-center space-x-2 text-error",children:[y.jsx(y0,{size:20}),y.jsx("span",{className:"text-sm font-medium flex-1",children:k})]}),y.jsxs("form",{onSubmit:H,className:"space-y-5 sm:space-y-6",children:[y.jsx(fc,{label:"Email or Username",type:"text",placeholder:"Enter your email or username",value:e.emailOrUsername,onChange:$=>Y("emailOrUsername",$.target.value),onBlur:()=>W("emailOrUsername"),error:s.emailOrUsername,icon:me,disabled:N}),y.jsxs("div",{className:"relative",children:[y.jsx(fc,{label:"Password",type:u?"text":"password",placeholder:"Enter your password",value:e.password,onChange:$=>Y("password",$.target.value),onBlur:()=>W("password"),error:s.password,icon:y.jsx(ry,{size:20}),disabled:N}),y.jsx("button",{type:"button",className:"absolute right-3 top-8 text-muted hover:text-subtle transition-colors",onClick:()=>h(!u),children:u?y.jsx(HT,{size:20}):y.jsx(op,{size:20})})]}),y.jsxs("div",{className:"flex items-center justify-between",children:[y.jsxs("label",{className:"flex items-center space-x-2",children:[y.jsx("input",{type:"checkbox",checked:e.rememberMe,onChange:$=>Y("rememberMe",$.target.checked.toString()),className:"w-4 h-4 text-primary border-default rounded focus:ring-primary"}),y.jsx("span",{className:"text-sm text-subtle",children:"Remember me"})]}),y.jsx("button",{type:"button",onClick:r,className:"text-sm text-subtle hover:text-default font-medium transition-colors",children:"Forgot password?"})]}),y.jsxs(Ke,{type:"submit",loading:N,className:"w-full",size:"lg",children:["Sign In",!N&&y.jsx(MT,{className:"ml-2 w-5 h-5"})]})]})]})})})})},e2=({onBackToLogin:r})=>{const[e,t]=le.useState(""),[s,l]=le.useState(""),[u,h]=le.useState(!1),[m,_]=le.useState(!1),{forgotPassword:w,isLoading:N}=fa(),k=()=>e.trim()?lp(e)?(l(""),!0):(l("Please enter a valid email address"),!1):(l("Email is required"),!1),I=async Y=>{Y.preventDefault(),k()&&(await w(e),h(!0))},z=Y=>{t(Y),m&&l("")},H=()=>{_(!0),k()};return u?y.jsx("div",{className:"min-h-screen bg-bg flex items-center justify-center p-3 sm:p-4",children:y.jsx("div",{className:"w-full max-w-sm sm:max-w-md",children:y.jsx("div",{className:"bg-bg rounded-2xl shadow-xl overflow-hidden border border-default",children:y.jsxs("div",{className:"px-6 sm:px-8 py-8 sm:py-12 text-center",children:[y.jsx("div",{className:"inline-flex items-center justify-center w-16 h-16 bg-success/10 rounded-2xl mb-6",children:y.jsx(UT,{className:"w-8 h-8 text-success"})}),y.jsx("h1",{className:"text-xl sm:text-2xl font-bold text-default mb-4",children:"Check Your Email"}),y.jsxs("p",{className:"text-subtle mb-8 leading-relaxed text-sm sm:text-base",children:["We've sent a password reset link to"," ",y.jsx("span",{className:"font-medium text-default break-all",children:e}),". Please check your email and follow the instructions to reset your password."]}),y.jsxs("div",{className:"space-y-3 sm:space-y-4",children:[y.jsxs(Ke,{onClick:r,variant:"primary",className:"w-full",size:"lg",children:[y.jsx(Qd,{className:"mr-2 w-5 h-5"}),"Back to Login"]}),y.jsx(Ke,{onClick:()=>h(!1),variant:"ghost",className:"w-full",children:"Didn't receive the email?"})]})]})})})}):y.jsx("div",{className:"min-h-screen bg-bg flex items-center justify-center p-3 sm:p-4",children:y.jsx("div",{className:"w-full max-w-sm sm:max-w-md",children:y.jsx("div",{className:"bg-bg rounded-2xl shadow-xl overflow-hidden border border-default",children:y.jsxs("div",{className:"px-6 sm:px-8 pt-6 sm:pt-8 pb-4 sm:pb-6",children:[y.jsxs("div",{className:"text-center mb-8",children:[y.jsx("div",{className:"inline-flex items-center justify-center w-16 h-16 bg-gradient-primary rounded-2xl mb-4",children:y.jsx(Jd,{className:"w-8 h-8 text-on-primary"})}),y.jsx("h1",{className:"text-2xl sm:text-3xl font-bold text-default mb-2",children:"Reset Password"}),y.jsx("p",{className:"text-subtle text-sm sm:text-base",children:"Enter your email address and we'll send you a link to reset your password"})]}),s&&y.jsxs("div",{className:"mb-6 p-3 sm:p-4 bg-gradient-theme border border-error rounded-lg flex items-center space-x-2 text-error",children:[y.jsx(y0,{size:20}),y.jsx("span",{className:"text-sm font-medium flex-1",children:s})]}),y.jsxs("form",{onSubmit:I,className:"space-y-5 sm:space-y-6",children:[y.jsx(fc,{label:"Email Address",type:"email",placeholder:"Enter your email address",value:e,onChange:Y=>z(Y.target.value),onBlur:H,error:s,icon:y.jsx(Jd,{size:20}),disabled:N}),y.jsx(Ke,{type:"submit",loading:N,className:"w-full",size:"lg",children:"Send Reset Link"})]}),y.jsx("div",{className:"mt-5 sm:mt-6 text-center",children:y.jsxs("button",{type:"button",onClick:r,className:"inline-flex items-center text-sm text-subtle hover:text-default font-medium transition-colors",children:[y.jsx(Qd,{className:"mr-2 w-4 h-4"}),"Back to Login"]})})]})})})})},t2=({isOpen:r,onClose:e})=>{const t="https://linktr.ee/esports_pxl",s=`https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=${encodeURIComponent(t)}`;return r?y.jsx("div",{className:"fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50",children:y.jsxs("div",{className:"bg-bg rounded-2xl p-6 w-full max-w-sm shadow-2xl animate-in zoom-in-95 duration-200",children:[y.jsxs("div",{className:"flex items-center justify-between mb-6",children:[y.jsx("h2",{className:"text-xl font-bold text-default",children:"QR Code"}),y.jsx("button",{onClick:e,className:"text-subtle hover:text-default transition-colors","aria-label":"Close modal",children:y.jsx(na,{className:"w-6 h-6"})})]}),y.jsxs("div",{className:"text-center space-y-4",children:[y.jsxs("div",{className:"bg-bg p-4 rounded-xl border border-default shadow-sm hover:shadow-md inline-block",children:[y.jsx("img",{src:s,alt:"QR Code for esports_pxl",className:"w-64 h-64 mx-auto",onError:l=>{const u=l.target;u.style.display="none",u.nextElementSibling?.classList.remove("hidden")}}),y.jsx("div",{className:"hidden w-64 h-64 bg-subtle rounded-lg flex items-center justify-center",children:y.jsxs("div",{className:"text-center",children:[y.jsx("div",{className:"text-4xl mb-2",children:"📱"}),y.jsx("p",{className:"text-sm text-subtle",children:"QR Code"})]})})]}),y.jsxs("div",{className:"space-y-2",children:[y.jsx("p",{className:"text-sm text-subtle",children:"Scan to visit:"}),y.jsx("div",{className:"bg-gray-50 bg-subtle rounded-lg p-3",children:y.jsx("p",{className:"text-sm font-mono text-default  break-all",children:t})})]}),y.jsxs("div",{className:"flex space-x-3 pt-4",children:[y.jsx(Ke,{onClick:e,variant:"outline",className:"flex-1",children:"Close"}),y.jsxs(Ke,{onClick:()=>window.open(t,"_blank"),className:"flex-1",children:[y.jsx(zT,{className:"w-4 h-4 mr-2"}),"Visit"]})]})]}),y.jsx("div",{className:"mt-6 pt-4 border-t border-default shadow-sm hover:shadow-md ",children:y.jsx("p",{className:"text-xs text-gray-500  text-center",children:"Point your camera at the QR code to open the link"})})]})}):null},n2=({onAddStock:r,onShowLog:e,onTakeItem:t})=>{const[s,l]=le.useState(!1),[u,h]=le.useState(!1),[m,_]=le.useState({x:20,y:20}),[w,N]=le.useState({x:0,y:0}),k=le.useRef(null),I=W=>{const me="touches"in W?W.touches[0].clientX:W.clientX,$="touches"in W?W.touches[0].clientY:W.clientY;h(!0),N({x:me-m.x,y:$-m.y})},z=W=>{if(!u)return;const me="touches"in W?W.touches[0].clientX:W.clientX,$="touches"in W?W.touches[0].clientY:W.clientY,ae=me-w.x,ce=$-w.y,ye=window.innerWidth-64,B=window.innerHeight-64;_({x:Math.max(0,Math.min(ae,ye)),y:Math.max(0,Math.min(ce,B))})},H=()=>{h(!1)};le.useEffect(()=>{if(u)return document.addEventListener("mousemove",z),document.addEventListener("mouseup",H),document.addEventListener("touchmove",z),document.addEventListener("touchend",H),()=>{document.removeEventListener("mousemove",z),document.removeEventListener("mouseup",H),document.removeEventListener("touchmove",z),document.removeEventListener("touchend",H)}},[u,w]),le.useEffect(()=>{const W=me=>{k.current&&!k.current.contains(me.target)&&l(!1)};return document.addEventListener("mousedown",W),()=>document.removeEventListener("mousedown",W)},[]);const Y=()=>{u||l(!s)};return y.jsx("div",{ref:k,className:"fixed z-50 select-none",style:{right:`${m.x}px`,bottom:`${m.y}px`},children:y.jsxs("div",{className:"relative",children:[s&&y.jsxs("div",{className:"absolute bottom-16 right-0 space-y-3 animate-in slide-in-from-bottom-2 duration-200",children:[y.jsx(Ke,{onClick:e,className:"w-12 h-12 rounded-full shadow-lg bg-purple-500 hover:bg-purple-600 text-on-primary p-0","aria-label":"Show log",children:y.jsx(op,{className:"w-6 h-6"})}),y.jsx(Ke,{onClick:r,className:"w-12 h-12 rounded-full shadow-lg bg-green-500 hover:bg-green-600 text-on-primary p-0","aria-label":"Add stock",children:y.jsx(Zi,{className:"w-6 h-6"})}),y.jsx(Ke,{onClick:t,className:"w-12 h-12 rounded-full shadow-lg bg-primary hover:bg-blue-600 text-on-primary p-0","aria-label":"Take item",children:y.jsx(ao,{className:"w-6 h-6"})})]}),y.jsx("button",{onMouseDown:I,onTouchStart:I,onClick:Y,className:`w-14 h-14 bg-gradient-to-br from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-on-primary rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center focus:outline-none focus:ring-4 focus:ring-orange-500/30 ${u?"cursor-grabbing scale-110":"cursor-grab hover:scale-105"}`,"aria-label":s?"Close fridge menu":"Open fridge menu",children:y.jsx("div",{className:`transition-transform duration-200 ${s?"rotate-45":""}`,children:y.jsx(Zi,{className:"w-7 h-7"})})})]})})},r2=({onBack:r})=>{const[e,t]=le.useState([{id:"1",name:"RedBull Energy Drink",stock:24,lastUpdated:new Date}]),[s,l]=le.useState([{id:"1",action:"take",amount:2,user:"Alice Johnson",timestamp:new Date(Date.now()-30*60*1e3),itemName:"RedBull Energy Drink"},{id:"2",action:"add",amount:12,user:"Bob Smith",timestamp:new Date(Date.now()-2*60*60*1e3),itemName:"RedBull Energy Drink"},{id:"3",action:"take",amount:1,user:"Carol Davis",timestamp:new Date(Date.now()-4*60*60*1e3),itemName:"RedBull Energy Drink"}]),[u,h]=le.useState(!1),[m,_]=le.useState(!1),[w,N]=le.useState(!1),[k,I]=le.useState(1),[z,H]=le.useState(1),Y=$=>{const ce=Math.floor((new Date().getTime()-$.getTime())/(1e3*60));if(ce<1)return"Just now";if(ce<60)return`${ce}m ago`;const ye=Math.floor(ce/60);return ye<24?`${ye}h ago`:`${Math.floor(ye/24)}d ago`},W=()=>{const $=e[0].stock;if(k>$)return;const ae=$-k;t(ye=>ye.map(B=>B.id==="1"?{...B,stock:ae,lastUpdated:new Date}:B));const ce={id:Date.now().toString(),action:"take",amount:k,user:"Demo User",timestamp:new Date,itemName:"RedBull Energy Drink"};l(ye=>[ce,...ye]),h(!1),I(1)},me=()=>{const ae=e[0].stock+z;t(ye=>ye.map(B=>B.id==="1"?{...B,stock:ae,lastUpdated:new Date}:B));const ce={id:Date.now().toString(),action:"add",amount:z,user:"Demo User",timestamp:new Date,itemName:"RedBull Energy Drink"};l(ye=>[ce,...ye]),_(!1),H(1)};return y.jsxs("div",{className:"min-h-screen bg-subtle pb-20",children:[y.jsx("header",{className:"bg-bg shadow-sm border-b border-default",children:y.jsx("div",{className:"max-w-7xl mx-auto px-3 sm:px-4 lg:px-8",children:y.jsx("div",{className:"flex justify-between items-center py-3 sm:py-4",children:y.jsxs("div",{className:"flex items-center space-x-3 sm:space-x-4",children:[y.jsx(Ke,{onClick:r,variant:"ghost",size:"sm",children:y.jsx(Qd,{className:"w-5 h-5"})}),y.jsx("div",{className:"w-10 h-10 bg-gradient-to-br from-orange-500 to-red-600 rounded-lg flex items-center justify-center",children:y.jsx(w0,{className:"w-6 h-6 text-on-primary"})}),y.jsxs("div",{className:"min-w-0 flex-1",children:[y.jsx("h1",{className:"text-xl sm:text-2xl font-bold text-default",children:"Fridge"}),y.jsx("p",{className:"text-subtle text-sm sm:text-base",children:"Stock management"})]})]})})})}),y.jsxs("main",{className:"max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8",children:[y.jsx("div",{className:"grid grid-cols-1 gap-4 mb-6",children:e.map($=>y.jsx("div",{className:"bg-bg rounded-xl p-6 border border-default shadow-sm",children:y.jsxs("div",{className:"flex items-center space-x-4",children:[y.jsx("div",{className:"w-16 h-16 bg-gradient-to-br from-red-500 to-orange-600 rounded-xl flex items-center justify-center",children:y.jsx(iy,{className:"w-8 h-8 text-on-primary"})}),y.jsxs("div",{className:"flex-1",children:[y.jsx("h3",{className:"text-lg font-semibold text-default  mb-1",children:$.name}),y.jsxs("div",{className:"flex items-center space-x-4 text-sm text-subtle",children:[y.jsxs("div",{className:"flex items-center space-x-1",children:[y.jsx(iy,{className:"w-4 h-4"}),y.jsxs("span",{children:[$.stock," in stock"]})]}),y.jsxs("div",{className:"flex items-center space-x-1",children:[y.jsx(hc,{className:"w-4 h-4"}),y.jsxs("span",{children:["Updated ",Y($.lastUpdated)]})]})]})]}),y.jsxs("div",{className:"text-right",children:[y.jsx("div",{className:"text-2xl font-bold text-default ",children:$.stock}),y.jsx("div",{className:"text-sm text-gray-500 ",children:"units"})]})]})},$.id))}),y.jsxs("div",{className:"bg-bg rounded-xl border border-default",children:[y.jsx("div",{className:"p-4 border-b border-default",children:y.jsx("h2",{className:"text-lg font-semibold text-default ",children:"Recent Activity"})}),y.jsx("div",{className:"divide-y divide-gray-200 ",children:s.slice(0,5).map($=>y.jsx("div",{className:"p-4",children:y.jsxs("div",{className:"flex items-center space-x-3",children:[y.jsx("div",{className:`w-8 h-8 rounded-full flex items-center justify-center ${$.action==="take"?"bg-red-100 ":"bg-green-100 "}`,children:$.action==="take"?y.jsx(ao,{className:`w-4 h-4 ${$.action==="take"?"text-red-600 ":"text-green-600 "}`}):y.jsx(Zi,{className:"w-4 h-4 text-green-600 "})}),y.jsxs("div",{className:"flex-1",children:[y.jsxs("p",{className:"text-sm font-medium text-default ",children:[$.user," ",$.action==="take"?"took":"added"," ",$.amount," ",$.itemName]}),y.jsx("p",{className:"text-xs text-gray-500 ",children:Y($.timestamp)})]}),y.jsxs("div",{className:`text-sm font-medium ${$.action==="take"?"text-red-600 ":"text-green-600 "}`,children:[$.action==="take"?"-":"+",$.amount]})]})},$.id))})]})]}),y.jsx(n2,{onTakeItem:()=>h(!0),onAddStock:()=>_(!0),onShowLog:()=>N(!0)}),u&&y.jsx("div",{className:"fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50",children:y.jsxs("div",{className:"bg-bg rounded-2xl p-6 w-full max-w-sm shadow-2xl",children:[y.jsx("h2",{className:"text-xl font-bold text-default  mb-4",children:"Take from Stock"}),y.jsxs("div",{className:"space-y-4",children:[y.jsxs("div",{children:[y.jsx("label",{className:"block text-sm font-medium text-default text-subtle mb-2",children:"Amount to take"}),y.jsxs("div",{className:"flex items-center space-x-3",children:[y.jsx(Ke,{onClick:()=>I(Math.max(1,k-1)),variant:"outline",size:"sm",children:y.jsx(ao,{className:"w-4 h-4"})}),y.jsx("span",{className:"text-lg font-semibold text-default  min-w-[3rem] text-center",children:k}),y.jsx(Ke,{onClick:()=>I(Math.min(e[0].stock,k+1)),variant:"outline",size:"sm",children:y.jsx(Zi,{className:"w-4 h-4"})})]}),y.jsxs("p",{className:"text-xs text-gray-500  mt-1",children:["Available: ",e[0].stock," units"]})]}),y.jsxs("div",{className:"flex space-x-3",children:[y.jsx(Ke,{onClick:()=>h(!1),variant:"outline",className:"flex-1",children:"Cancel"}),y.jsx(Ke,{onClick:W,className:"flex-1",children:"Take"})]})]})]})}),m&&y.jsx("div",{className:"fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50",children:y.jsxs("div",{className:"bg-bg rounded-2xl p-6 w-full max-w-sm shadow-2xl",children:[y.jsx("h2",{className:"text-xl font-bold text-default  mb-4",children:"Add to Stock"}),y.jsxs("div",{className:"space-y-4",children:[y.jsxs("div",{children:[y.jsx("label",{className:"block text-sm font-medium text-default text-subtle mb-2",children:"Amount to add"}),y.jsxs("div",{className:"flex items-center space-x-3",children:[y.jsx(Ke,{onClick:()=>H(Math.max(1,z-1)),variant:"outline",size:"sm",children:y.jsx(ao,{className:"w-4 h-4"})}),y.jsx("span",{className:"text-lg font-semibold text-default  min-w-[3rem] text-center",children:z}),y.jsx(Ke,{onClick:()=>H(z+1),variant:"outline",size:"sm",children:y.jsx(Zi,{className:"w-4 h-4"})})]})]}),y.jsxs("div",{className:"flex space-x-3",children:[y.jsx(Ke,{onClick:()=>_(!1),variant:"outline",className:"flex-1",children:"Cancel"}),y.jsx(Ke,{onClick:me,className:"flex-1",children:"Add"})]})]})]})}),w&&y.jsx("div",{className:"fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50",children:y.jsxs("div",{className:"bg-bg rounded-2xl p-6 w-full max-w-md shadow-2xl max-h-[80vh] overflow-hidden",children:[y.jsxs("div",{className:"flex items-center justify-between mb-4",children:[y.jsx("h2",{className:"text-xl font-bold text-default ",children:"Activity Log"}),y.jsx(Ke,{onClick:()=>N(!1),variant:"ghost",size:"sm",children:y.jsx(na,{className:"w-5 h-5"})})]}),y.jsx("div",{className:"overflow-y-auto max-h-96 space-y-3",children:s.map($=>y.jsxs("div",{className:"flex items-center space-x-3 p-3 bg-gray-50 bg-subtle rounded-lg",children:[y.jsx("div",{className:`w-8 h-8 rounded-full flex items-center justify-center ${$.action==="take"?"bg-red-100 ":"bg-green-100 "}`,children:$.action==="take"?y.jsx(ao,{className:"w-4 h-4 text-red-600 "}):y.jsx(Zi,{className:"w-4 h-4 text-green-600 "})}),y.jsxs("div",{className:"flex-1",children:[y.jsx("p",{className:"text-sm font-medium text-default ",children:$.user}),y.jsxs("p",{className:"text-xs text-subtle",children:[$.action==="take"?"Took":"Added"," ",$.amount," units"]}),y.jsxs("p",{className:"text-xs text-gray-500 ",children:[$.timestamp.toLocaleDateString()," ",$.timestamp.toLocaleTimeString()]})]}),y.jsxs("div",{className:`text-sm font-medium ${$.action==="take"?"text-red-600 ":"text-green-600 "}`,children:[$.action==="take"?"-":"+",$.amount]})]},$.id))})]})})]})},i2=({user:r,onClose:e})=>{const t=le.useRef(null);return le.useEffect(()=>{const s=l=>{t.current&&!t.current.contains(l.target)&&e()};return document.addEventListener("mousedown",s),()=>{document.removeEventListener("mousedown",s)}},[e]),y.jsx("div",{className:"fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-4",children:y.jsxs("div",{ref:t,className:"bg-bg rounded-lg shadow-lg w-full max-w-sm sm:max-w-md md:max-w-lg p-6 relative border border-default",children:[y.jsx("button",{onClick:e,className:"absolute top-4 right-4 text-subtle hover:text-default",children:y.jsx(na,{className:"w-5 h-5"})}),y.jsx("div",{className:"flex justify-center -mt-16",children:y.jsx("img",{src:r.avatar,alt:`${r.name}'s avatar`,onError:s=>{s.currentTarget.onerror=null,s.currentTarget.style.display="none";const l=s.currentTarget.parentElement;if(l&&!l.querySelector(".fallback-avatar")){const u=document.createElement("span");u.className="fallback-avatar flex items-center justify-center w-32 h-32 rounded-full bg-subtle border-4 border-bg shadow-lg",u.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" class="w-20 h-20 text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.121 17.804A9.001 9.001 0 0112 15c2.21 0 4.21.805 5.879 2.146"/></svg>',l.appendChild(u)}},className:"w-32 h-32 rounded-full border-4 border-bg shadow-lg"})}),y.jsx("h2",{className:"text-xl font-bold text-default mt-4 text-center",children:r.name}),y.jsxs("div",{className:"space-y-2 mt-4",children:[y.jsxs("p",{className:"text-sm text-subtle",children:[y.jsx("strong",{children:"Username:"})," ",r.username]}),y.jsxs("p",{className:"text-sm text-subtle",children:[y.jsx("strong",{children:"Last Check-in:"})," ",r.location," at ",r.checkedInAt.toLocaleString()]}),y.jsxs("p",{className:"text-sm text-subtle",children:[y.jsx("strong",{children:"Email:"})," ",r.email||"N/A"]}),y.jsxs("p",{className:"text-sm text-subtle",children:[y.jsx("strong",{children:"Phone:"})," ",r.phoneNumber||"N/A"]}),y.jsxs("p",{className:"text-sm text-subtle",children:[y.jsx("strong",{children:"Discord:"})," ",r.discordUsername||"N/A"]}),y.jsxs("p",{className:"text-sm text-subtle",children:[y.jsx("strong",{children:"Friends:"})," ",r.friendCount||0]})]})]})})},s2=({onShowQR:r,onOpenFridge:e,onCheckIn:t,onCheckOut:s,isCheckedIn:l})=>{const[u,h]=le.useState(!1),[m,_]=le.useState(!1),[w,N]=le.useState("PXL"),[k,I]=le.useState(0),z=[{id:"PXL",name:"PXL",color:"bg-location-pxl"},{id:"RBGH",name:"RBGH",color:"bg-location-rbgh"},{id:"STREAM",name:"Streaming room",color:"bg-location-stream"}],H=()=>{const W=Array(k).fill("").map((me,$)=>`friend_${$+1}`);t(w,W),_(!1)},Y=()=>{const W=Array(k).fill("").map((me,$)=>`friend_${$+1}`);t(w,W),_(!1)};return y.jsxs(y.Fragment,{children:[y.jsx("div",{className:"fixed bottom-[5.5rem] right-4 z-50 sm:hidden",children:y.jsxs("div",{className:"relative flex flex-col items-center",children:[y.jsxs("div",{className:`flex flex-col items-center space-y-3 absolute bottom-16 ${u?"opacity-100 translate-y-0":"opacity-0 pointer-events-none translate-y-2"} transition-all duration-300 ease-in-out`,children:[y.jsx("button",{onClick:()=>_(!0),className:"w-12 h-12 rounded-full flex items-center justify-center bg-primary text-on-primary shadow-md hover:scale-105 transition","aria-label":"More options",children:y.jsx(WT,{className:"w-5 h-5"})}),y.jsx("button",{onClick:e,className:"w-12 h-12 rounded-full flex items-center justify-center bg-primary text-on-primary shadow-md hover:scale-105 transition","aria-label":"Fridge",children:y.jsx(w0,{className:"w-5 h-5"})}),y.jsx("button",{onClick:r,className:"w-12 h-12 rounded-full flex items-center justify-center bg-primary text-on-primary shadow-md hover:scale-105 transition","aria-label":"QR Code",children:y.jsx(KT,{className:"w-5 h-5"})})]}),y.jsx("button",{onClick:()=>h(!u),className:"w-14 h-14 rounded-full flex items-center justify-center bg-primary text-on-primary shadow-xl hover:scale-105 transition-all duration-300","aria-label":"Toggle actions",children:u?y.jsx(na,{className:"w-6 h-6"}):y.jsx(GT,{className:"w-6 h-6"})})]})}),m&&y.jsx("div",{onClick:()=>_(!1),className:"fixed inset-0 bg-black/50 z-40","aria-hidden":"true"}),y.jsx("div",{className:`fixed inset-0 z-50 bg-bg transform transition-transform duration-300 ${m?"translate-x-0":"-translate-x-full"}`,children:y.jsxs("div",{className:"p-6 space-y-6 h-full overflow-y-auto relative",children:[y.jsx("button",{onClick:()=>_(!1),className:"absolute top-4 right-4 z-50 bg-primary text-on-primary p-2 rounded-full shadow focus:outline-none focus:ring-4 focus:ring-primary","aria-label":"Close sidebar",children:y.jsx(na,{className:"w-6 h-6"})}),y.jsx("h3",{className:"text-lg font-semibold text-default mt-6",children:l?"Change Location":"Check In"}),y.jsxs("div",{className:"mt-4",children:[y.jsx("label",{className:"block text-sm font-medium text-subtle mb-3",children:l?"Select a new location to change":"Choose Location"}),y.jsx("div",{className:"space-y-2",children:z.map(W=>y.jsxs("button",{onClick:()=>N(W.id),className:`w-full p-3 rounded-lg border-2 transition-all text-left flex items-center space-x-3
                    ${w===W.id?"bg-subtle border-secondary text-default":"border-default bg-subtle text-default shadow-sm hover:shadow-md hover:border-secondary"}`,children:[y.jsx("div",{className:`w-4 h-4 rounded-full ${W.color}`}),y.jsx("span",{className:"font-medium",children:W.name})]},W.id))})]}),y.jsxs("div",{className:"mt-6",children:[y.jsx("label",{className:"block text-sm font-medium text-subtle mb-3",children:l?"Update friend count":"Check in with friends"}),y.jsxs("div",{className:"flex items-center space-x-4",children:[y.jsx("button",{onClick:()=>I(W=>Math.max(W-1,0)),className:"w-10 h-10 bg-subtle flex items-center justify-center","aria-label":"Decrease friend count",children:y.jsx(ao,{className:"w-5 h-5 text-subtle"})}),y.jsxs("div",{className:"flex items-center space-x-2 min-w-0 flex-1",children:[y.jsx(dc,{className:"w-5 h-5 text-subtle"}),y.jsx("span",{className:"text-lg font-semibold text-default",children:k}),y.jsxs("span",{className:"text-sm text-subtle",children:["friend",k!==1?"s":""]})]}),y.jsx("button",{onClick:()=>I(W=>Math.min(W+1,10)),className:"w-10 h-10 bg-subtle flex items-center justify-center","aria-label":"Increase friend count",children:y.jsx(Zi,{className:"w-5 h-5 text-subtle"})})]})]}),l?y.jsx(Ke,{onClick:Y,className:"w-full bg-primary hover:bg-secondary text-on-primary p-3 rounded-lg mt-6",children:"Update"}):y.jsx(Ke,{onClick:H,className:"w-full bg-secondary hover:bg-secondary text-on-primary p-3 rounded-lg mt-6",children:"Check In"}),l&&y.jsxs(Ke,{onClick:()=>{s(),_(!1)},className:"w-full bg-primary hover:bg-secondary text-on-primary p-3 rounded-lg mt-6",children:[y.jsx(Xd,{className:"w-5 h-5 mr-2"}),"Check Out"]})]})})]})},oy="https://api.boelguard.me/",o2=({type:r,message:e})=>y.jsxs("div",{className:`fixed left-1/2 top-0 z-50 w-full max-w-xs sm:max-w-sm -translate-x-1/2 mt-6
